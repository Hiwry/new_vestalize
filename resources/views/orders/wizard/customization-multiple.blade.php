...
<div class="max-w-[1520px] mx-auto pt-2 md:pt-3 pb-4 md:pb-6">
            ...
            <div class="p-6">
                        ...
                        <div class="ow-surface-card p-5">
                            <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <span class="inline-flex items-center gap-2 rounded-full bg-gray-100 dark:bg-slate-800/50 px-3 py-2 text-xs font-semibold text-gray-600 dark:text-slate-300">
                ...
                <div id="customization-summary" class="ow-surface-card p-5">
                    <div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between mb-5">
                        ...
                        <span class="inline-flex items-center gap-2 rounded-full bg-white dark:bg-slate-800/50 px-3 py-2 text-xs font-semibold text-gray-600 dark:text-slate-300 border border-gray-200 dark:border-slate-700/50">
                        ...
                        <div id="item-card-{{ $item->id }}" class="ow-item-frame">
                            ...
                            <div class="px-5 py-5 border-b border-gray-200 dark:border-slate-700 bg-gradient-to-r from-white to-gray-50 dark:from-slate-900 dark:to-slate-800/70">
                                <div class="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                                    ...
                                    @else
                                        <div class="xl:w-[320px] rounded-2xl border border-dashed border-gray-300 dark:border-slate-700/50 bg-white/70 dark:bg-slate-800/20 px-4 py-4">
                            ...
                            @else
                                <div class="mt-3 mx-5 rounded-2xl border border-dashed border-gray-300 dark:border-slate-700/50 bg-gray-50/80 dark:bg-slate-800/20 p-4">
                ...
                <!-- Navegação -->
                    ...
                    <aside class="space-y-6 xl:sticky xl:top-6">
                        ...
                        <div class="hidden xl:flex ow-aside-card p-4 flex-col gap-3">
                            <a href="{{ request()->routeIs('orders.edit.*') ? route('orders.edit.sewing') : route('orders.wizard.sewing') }}" 
                               class="w-full px-4 py-2.5 text-sm text-center text-gray-600 dark:text-slate-400 hover:text-gray-900 dark:hover:text-white font-medium rounded-xl border border-gray-200 dark:border-slate-700/50 bg-white dark:bg-slate-800/20 transition-all hover:bg-gray-50 dark:hover:bg-slate-800/40">
    ...
    <div id="deleteConfirmationModal" class="hidden fixed inset-0 bg-black/50 dark:bg-black/80 z-50 flex items-center justify-center p-4">
        <div class="bg-white dark:bg-[#10203a] rounded-lg max-w-md w-full shadow-xl border border-gray-200 dark:border-slate-700">
        ...
        function openAddonModal() {
            ...
            const modalHtml = `
                <div id="addonModal" class="fixed inset-0 bg-black/60 dark:bg-black/70 z-[60] flex items-center justify-center p-4 backdrop-blur-sm animate-fadeIn">
                    <div class="relative w-full max-w-lg shadow-2xl rounded-2xl bg-white dark:bg-[#10203a] border border-gray-200 dark:border-slate-700/50 overflow-hidden animate-slideUp">
                        <!-- Header com gradiente -->
                        <div class="px-6 py-5 bg-gradient-to-r from-emerald-500/10 via-white to-white dark:from-emerald-600/20 dark:via-[#10203a] dark:to-[#10203a] border-b border-gray-200 dark:border-slate-700/50">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
