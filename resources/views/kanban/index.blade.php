...
<div class="max-w-[1800px] mx-auto">
            ...
            <form method="GET" action="{{ route('kanban.index') }}" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="flex items-end gap-2">
                        ...
                        @if($search || request('personalization_type') || ($deliveryDateFilter ?? request('delivery_date')) || ($entryDateFilter ?? request('entry_date')))
        ...
        @php
            $hasFilters = ($deliveryDateFilter ?? request('delivery_date')) || ($entryDateFilter ?? request('entry_date')) || ($personalizationType ?? request('personalization_type')) || ($search ?? request('search'));
        @endphp
