...
@php
    $cards = [
        [
            'title' => 'Dashboard',
            'desc' => 'Visão consolidada do fluxo financeiro, relatórios e lucros.',
            'route' => route('financial.dashboard'),
            'accent' => '#7c3aed',
            'icon' => 'fa-chart-pie',
        ],
        [
            'title' => 'Caixa',
            'desc' => 'Gerencie entradas, saídas e movimentações financeiras.',
            'route' => route('cash.index'),
            'accent' => '#059669',
            'icon' => 'fa-cash-register',
        ],
        [
            'title' => 'Aprovações PDV',
            'desc' => 'Controle caixas abertos e concilie transações de vendas no balcão.',
            'route' => route('cash.approvals.index'),
            'accent' => '#3b82f6',
    ...
    if (Auth::user()->tenant_id === null || Auth::user()->tenant?->canAccess('invoices')) {
        $cards[] = [
            'title' => 'Notas Fiscais',
            'desc' => 'Emissão e gestão de NF-e e NFC-e da sua empresa.',
        ...
        $cards[] = [
            ...
            'desc' => 'Gerencie certificados digitais, tributos e naturezas de operação.',
            'route' => route('admin.invoice-config.edit'),
            'accent' => '#64748b',
            'icon' => 'fa-gear',
        ];
    }
...
<div class="max-w-[1520px] mx-auto pt-2 md:pt-3 pb-4 md:pb-6">
    <section class="sales-hub">
        <div class="sh-topbar">
            <div class="sh-brand">
                <span class="sh-logo"><i class="fa-solid fa-coins"></i></span>
                <div>
                    <h1 class="sh-title">Central Financeira</h1>
                    <p class="sh-subtitle">Escolha o fluxo financeiro e acesse as operações mais usadas</p>
                </div>
            </div>

            <div class="sh-actions">
                <a href="{{ route('cash.index') }}" class="sh-action sh-action-success">
                    <i class="fa-solid fa-cash-register"></i>
                    <span>Acessar Caixa</span>
                </a>
                <a href="{{ route('financial.dashboard') }}" class="sh-action sh-action-primary">
        ...
        <div class="sh-intro">
            <p>Todos os módulos financeiros foram padronizados no mesmo estilo visual do dashboard para facilitar navegação, leitura e operação diária.</p>
        </div>
