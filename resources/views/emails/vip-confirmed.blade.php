...
<html>
<head>
    <title>Bem-vindo à Lista VIP do Vestalize</title>
</head>
<body style="font-family: sans-serif; background-color: #f4f4f9; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background: white; padding: 30px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
        ...
        <ul>
            <li>Condições especiais de preço no lançamento.</li>
            <li>Acesso antecipado ao sistema.</li>
            <li>Acompanhamento exclusivo de onboarding.</li>
        </ul>
        <p>Fique atento ao seu e-mail e WhatsApp. Em breve enviaremos novidades!</p>
        <br>
        <p style="color: #64748b; font-size: 0.9em;">Equipe Vestalize</p>
    </div>
</body>
</html>
