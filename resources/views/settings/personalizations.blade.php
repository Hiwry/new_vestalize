...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <a href="{{ route('admin.personalization-prices.edit', 'SUB. TOTAL') }}" class="group block p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-purple-100 dark:border-purple-900/30 hover:border-purple-300 dark:hover:border-purple-700 hover:shadow-md transition-all duration-200">
        <div class="flex items-center space-x-4 mb-4">
