...
@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Novo Modelo</h1>
    <p class="text-gray-600 dark:text-gray-400 mt-2">Adicione um novo modelo ao catálogo</p>
</div>
