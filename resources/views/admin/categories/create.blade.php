...
@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Nova Categoria</h1>
    <p class="text-gray-600 dark:text-gray-400 mt-2">Adicione uma nova categoria ao catálogo</p>
</div>
