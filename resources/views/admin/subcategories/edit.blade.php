...
@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Editar Subcategoria</h1>
    <p class="text-gray-600 dark:text-gray-400 mt-2">Edite as informações da subcategoria</p>
</div>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea id="description" 
                          name="description" 
                          rows="3"
                          class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-gray-100">{{ old('description', $subcategory->description) }}</textarea>
            </div>
