...
@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Nova Personalização</h1>
    <p class="text-gray-600 dark:text-gray-400 mt-2">Adicione uma nova personalização ao catálogo</p>
</div>

<div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-6">
    <form action="{{ route('admin.personalizacoes.store') }}" method="POST">
        @csrf
