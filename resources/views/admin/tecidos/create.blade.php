...
@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Novo Tecido</h1>
    <p class="text-gray-600 dark:text-gray-400 mt-2">Adicione um novo tecido ao catálogo</p>
</div>

<div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-6">
    <form action="{{ route('admin.tecidos.store') }}" method="POST">
        @csrf
