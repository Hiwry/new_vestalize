    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-6">
        <form method="POST" action="{{ route('admin.tenants.store') }}">
            ...
            <div class="space-y-6">
                ...
                <!-- Código de Afiliado -->
                <div>
                    <label for="affiliate_code" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    ...
                    <div class="flex gap-2">
                        <input type="text" name="affiliate_code" id="affiliate_code" 
                            ...
                            maxlength="8"
                            class="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 uppercase">
                        <button type="button" id="validateAffiliateBtn"
                            class="px-4 py-2 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                            Validar
                        </button>
                    </div>
                    <p id="affiliateMessage" class="mt-1 text-sm hidden"></p>
                </div>
