        ...
        <div class="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-xl shadow-lg mb-6 overflow-hidden">
            <div class="px-5 py-4 border-b border-white/10">
                <div class="flex items-center space-x-2">
                    ...
                    <h2 class="font-semibold text-white">Resumo do Orçamento</h2>
                </div>
            </div>
            <div class="p-5 text-white">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    <div class="bg-white/10 rounded-lg p-3">
                        <p class="text-xs text-white/60 mb-1">Quantidade</p>
                        <p class="text-lg font-bold" x-text="(form.quantity || 0) + ' peças'"></p>
                    </div>
                    <div class="bg-white/10 rounded-lg p-3">
                        <p class="text-xs text-white/60 mb-1">Personalização</p>
                        <p class="text-lg font-bold" x-text="form.technique || '-'"></p>
                    </div>
                    <div class="bg-white/10 rounded-lg p-3">
                        <p class="text-xs text-white/60 mb-1">Valor unitário</p>
                        <p class="text-lg font-bold" x-text="formatCurrency(form.unit_price || 0)"></p>
                    </div>
                    <div class="bg-white/10 rounded-lg p-3">
                        <p class="text-xs text-white/60 mb-1">Prazo</p>
                        <p class="text-lg font-bold" x-text="(form.deadline_days || 15) + ' dias'"></p>
                    </div>
                </div>
                <div class="bg-white/20 rounded-lg p-4 text-center">
                    <p class="text-sm text-white/80 mb-1">Total do Orçamento</p>
                    <p class="text-3xl font-bold" x-text="formatCurrency(total)"></p>
                </div>
            </div>
        </div>
