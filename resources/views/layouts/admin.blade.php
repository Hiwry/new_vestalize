        ...
        <div id="main-content" class="h-screen overflow-y-auto bg-background transition-all duration-300 ease-in-out">
            <main class="min-h-full pb-24 md:pb-10 pt-20 px-4 md:pt-6 md:px-6 w-full">
                ...
                @auth
                    ...
                    <div x-data="{ show: true }" x-show="show" x-transition class="mb-4 w-full max-w-7xl mx-auto">
                        <div class="bg-gradient-to-r from-red-600 via-red-500 to-orange-500 rounded-2xl shadow-lg shadow-red-500/20">
                            <div class="px-4 py-3 sm:px-6">
                                <div class="flex items-center justify-between flex-wrap gap-2">
                                    <div class="flex items-center flex-1 min-w-0">
                                        ...
                                        <p class="ml-3 text-sm font-medium" style="color: #ffffff !important;">
                                    ...
                                    <div class="flex items-center gap-2 flex-shrink-0">
                                        <a href="https://wa.me/5500000000000?text=Olá!%20Gostaria%20de%20renovar%20minha%20assinatura%20do%20Vestalize." 
                                           target="_blank"
                                           class="flex items-center px-4 py-2 rounded-md text-sm font-bold shadow-sm hover:bg-red-50 transition-colors" style="background: #ffffff !important; color: #dc2626 !important;">
                                        ...
                                        <button @click="show = false" class="flex p-1 rounded-md hover:bg-red-700/50 transition-colors" style="color: #ffffff !important;" title="Fechar">
