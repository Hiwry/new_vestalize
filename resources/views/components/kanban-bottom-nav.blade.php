...
<div class="fixed bottom-8 left-1/2 -translate-x-1/2 z-[100] w-auto">
    <div class="kanban-bottom-nav bg-white/95 dark:bg-gray-900/90 backdrop-blur-md px-2 py-2 rounded-full shadow-2xl border border-gray-200 dark:border-white/10 flex items-center gap-1">
        ...
        <button @click="view = (view === 'kanban' ? 'calendar' : 'kanban')" 
                class="kanban-bottom-control flex items-center gap-2 px-4 py-2 rounded-full text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/10 transition-all duration-200">
        ...
        <a href="{{ route('production.index', ['type' => $activeType]) }}" 
           class="kanban-bottom-control flex items-center justify-center p-2 rounded-full text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/10 transition-all duration-200"
