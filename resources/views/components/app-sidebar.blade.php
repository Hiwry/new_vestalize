        ...
        @else
            ...
            <div class="mt-1">
                ...
                <div x-show="openGroups.financeiro && expanded" x-collapse x-cloak class="space-y-1 mt-1 bg-gray-50 dark:bg-gray-900/50 rounded-md overflow-hidden">
                    ...
                    <a href="{{ route('cash.index') }}" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition {{ request()->routeIs('cash.index') && !request()->routeIs('cash.approvals.*') ? 'bg-gray-100 dark:bg-gray-800 text-green-600 dark:text-green-400' : '' }}">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 {{ request()->routeIs('cash.index') && !request()->routeIs('cash.approvals.*') ? 'bg-green-600' : '' }}"></span>
                        Caixa
                    </a>
