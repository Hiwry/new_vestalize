...
class OrderWizardService
{
    ...
    public function resolveStoreId(?\App\Models\User $user = null): ?int
    {
        ...
        // 1. Tentar primeiro obter a loja vinculada diretamente ao papel do usuário (Admin de Loja ou Vendedor)
        ...
        // 2. Fallback: Se não encontrou via role, tentar obter loja do tenant do usuário
    ...
    public function processAddSublimationItem(Order $order, array $validated, ?string $coverImagePath = null, ?string $corelFilePath = null): OrderItem
    {
        ...
        $item = new OrderItem([
            ...
            'print_desc' => json_encode([
                ...
                'tecido_id' => $validated['tecido_id'] ?? $typeModel?->tecido_id,
