...
class ProductController extends Controller
{
    ...
    private function getTemplates(): array
    {
        return [
            ...
            'description' => 'Camiseta clássica gola redonda, ideal para personalização.',
            'category' => 'Camisetas',
            'tecido_keyword' => 'Algodão',
            'default_price' => 18.67,
            'icon' => 'fa-shirt',
            'compatible_cuts' => ['basica', 'babylook', 'infantil'],
        ...
        'polo' => [
            ...
            'description' => 'Camisa polo com peitilho e gola em ribana. Visual executivo.',
            'category' => 'Polos',
        ...
        'moletom_canguru' => [
            ...
            'description' => 'Blusa de moletom com bolso frontal e capuz ajustável.',
            'category' => 'Moletons',
            'tecido_keyword' => 'Moletom',
            'default_price' => 120.00,
            'icon' => 'fa-vest',
            'compatible_cuts' => ['basica', 'infantil'],
            'allow_application' => true,
        ],
        'conjunto_esportivo' => [
            'title' => 'Conjunto Esportivo Dry Fit',
            'description' => 'Camiseta e calção em tecido tecnológico que facilita a transpiração.',
            'category' => 'Esportivo',
            'tecido_keyword' => 'Dry',
            'default_price' => 85.00,
            'icon' => 'fa-running',
