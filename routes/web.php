        ...
        Route::prefix('sublimation-total')->group(function () {
            ...
            Route::get('/addons/{type}', function (Request $request, string $type) {
                ...
                return response()->json([
                    ...
                    'models_surcharge_disabled' => array_values(array_map('strtoupper', $productType?->models_surcharge_disabled ?? [])),
                    'collars' => $effectiveCollars,
                    'apply_size_surcharge' => (bool) ($productType?->apply_size_surcharge ?? true),
