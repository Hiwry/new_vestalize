...
const SectionBadge = ({ title, className }: Props) => {
    return (
        ...
        >
            ...
            <motion.div
                className={cn(
                    "relative z-0 px-4 pt-2 pb-1.5 rounded-full text-xs bg-[linear-gradient(110deg,#a3a3a3,45%,#fafafa,55%,#a3a3a3)] bg-size-[250%_100%] bg-clip-text animate-background-shine text-transparent font-medium uppercase bg-background/5 border-b border-border shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.15),inset_0_1px_0_0_rgba(255,255,255,0.1)] backdrop-blur-sm overflow-hidden",
