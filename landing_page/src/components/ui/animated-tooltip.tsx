            ...
            {items.map((item, idx) => (
                ...
                >
                    <AnimatePresence>
                        {hoveredIndex === item.id && (
                            ...
                            >
                                ...
                                <div className="relative z-30 text-base bg-linear-to-r from-text-primary to-text-primary/70 text-transparent bg-clip-text font-medium">
                                    {item.name}
                                </div>
                    ...
                    <img
                        ...
                        src={item.image}
                        alt={item.name}
                        className="relative m-0! size-10 rounded-full border-2 border-border object-cover object-top p-0! transition duration-500 group-hover:z-30"
                    />
                </div>
            ))}
        </>
