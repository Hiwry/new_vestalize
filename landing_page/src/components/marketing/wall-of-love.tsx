        ...
        <section className="w-full py-16 lg:py-24 relative overflow-visible">
            ...
            <Wrapper>
                ...
                <div className="w-full md:max-w-2xl lg:max-w-3xl mx-auto mt-12 relative">
                    <div className="relative rounded-2xl px-6 py-8 lg:p-12 overflow-hidden bg-cardbox border border-border shadow-card">
                        <AnimatePresence mode="wait" custom={direction}>
                            ...
                            >
                                ...
                                <p className="text-base md:text-lg lg:text-xl text-text-primary text-balance leading-relaxed mt-6 max-w-full md:max-w-xl lg:max-w-2xl">
                    ...
                    <div className="flex items-center justify-center gap-3 mt-6">
                        <button
                            ...
                            className="size-10 rounded-full bg-surface hover:bg-brand-soft border border-border hover:border-primary/40 shadow-card flex items-center justify-center transition-all group cursor-pointer"
                        >
