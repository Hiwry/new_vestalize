...
const Footer = () => {
    ...
    return (
        <footer className="w-full relative mt-16 lg:mt-24 overflow-hidden">
            <div className="absolute top-0 inset-x-0 h-px bg-linear-to-r from-text-primary/0 via-text-primary/20 to-text-primary/0" />
            <div className="absolute top-0 inset-x-0 w-1/2 mx-auto h-4 bg-primary/30 blur-[4rem]" />
            ...
            <Wrapper className="py-12">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
                        ...
                        <form onSubmit={handleSubmit} className="mt-6 w-full md:max-w-xs">
                            <div className="flex gap-2">
                                <Input
                                    ...
                                    required
                                    className="flex-1 h-8.5 text-sm bg-surface border-border focus-visible:ring-0 focus-visible:ring-transparent rounded-full px-4 shadow-card"
                                />
                    ...
                    <div className="lg:col-span-6 grid grid-cols-2 md:grid-cols-3 lg:place-items-end gap-8">
                        <div>
                            <h3 className="text-sm font-semibold text-text-primary mt-0">
                                Product
                            </h3>
