            ...
            <Wrapper>
                ...
                <div className="relative max-w-5xl mx-auto mt-12">
                            ...
                            <div className="space-y-3 relative">
                                {OTHER_TOOLS.map((item, index) => (
                                    <motion.div
                                        ...
                                        className="flex items-center gap-3 px-4 py-3 rounded-xl bg-surface border border-border shadow-card hover:bg-brand-soft transition-all duration-300 cursor-pointer"
                                    >
                            ...
                            <div className="space-y-3 relative">
                                {AVENTO_FEATURES.map((item, index) => (
                                    <motion.div
                                        ...
                                        className="flex items-center gap-3 px-4 py-3 rounded-xl bg-primary/7.5 backdrop-blur-sm hover:bg-primary/10 border border-primary/15 hover:border-primary/25 transition-all duration-300 cursor-pointer"
                                    >
                    ...
                    <div className="absolute top-0 bottom-0 left-1/2 -translate-x-1/2 hidden lg:flex flex-col items-center justify-center lg:pt-14">
                        ...
                        >
                            <Icons.icon className="size-5 text-text-secondary mb-0.5 mr-0.5" />
