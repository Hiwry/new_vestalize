...
const IntegrationCard = ({
    ...
    return (
        <div
            className={cn(
                "relative group flex size-12 rounded-full border border-border bg-surface shadow-card",
                className
            )}
        >
            {iconSrc ? (
        ...
        <section id="integrations" className="w-full py-16 lg:py-24 relative z-0">
            ...
            <Wrapper>
                <div className="aspect-16/10 group relative mx-auto flex max-w-80 items-center justify-between sm:max-w-xs lg:max-w-md">
                    <div
                        role="presentation"
                        className="bg-linear-to-b border-border absolute inset-0 z-10 aspect-square animate-spin hidden lg:block items-center justify-center rounded-full border-t from-primary/15 to-transparent to-25% opacity-0 duration-[3.5s] group-hover:opacity-100"
                    />

                    <div
                        role="presentation"
                        className="bg-linear-to-b border-border absolute inset-16 z-10 aspect-square scale-90 animate-spin items-center justify-center rounded-full border-t from-primary/15 to-transparent to-25% opacity-0 duration-[3.5s] group-hover:opacity-100"
                    ...
                    <motion.div
                        ...
                        className="bg-linear-to-b from-primary/12 absolute inset-0 flex aspect-square items-center justify-center rounded-full border-t border-border to-transparent to-25% z-30"
                    >
                        <IntegrationCard
                    ...
                    <motion.div
                        ...
                        className="bg-linear-to-b from-primary/12 absolute inset-16 flex aspect-square scale-90 items-center justify-center rounded-full border-t border-border to-transparent to-25% z-30"
                    >
                        <IntegrationCard
                            className="absolute top-0 -translate-y-1/2"
                    ...
                    <Container animation="blurIn" delay={0.5} className="absolute inset-x-0 bottom-0 lg:bottom-1/10 mx-auto my-2 flex justify-center gap-2 w-fit scale-90 lg:scale-100">
                        <div className="bg-brand-soft relative z-20 rounded-full border border-border shadow-card p-1.5 group">
