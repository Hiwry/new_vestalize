                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 mt-12 max-w-5xl mx-auto">
                    <motion.div
                        className={cn(
                            ...
                            "bg-cardbox border border-border shadow-card",
                    ...
                    >
                        ...
                        >
                            <div className="relative overflow-visible">
                                ...
                                <h3 className="text-2xl bg-linear-to-r from-text-primary to-text-primary/70 text-transparent bg-clip-text font-medium mt-4">
                        ...
                        >
                            <div className="relative">
                                <div className="flex items-baseline gap-1">
                                    <h3 className="text-3xl bg-linear-to-r from-text-primary to-text-primary/70 text-transparent bg-clip-text font-semibold">
                                        {stats[1]?.value} Sends
                                    </h3>
                                </div>
