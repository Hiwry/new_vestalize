...
<div class="max-w-3xl mx-auto">
        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="<?php echo e(route('admin.product-options.index', ['type' => $option->type])); ?>" 
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 border border-gray-200 dark:border-gray-700">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Editar Opção: <?php echo e($option->name); ?></h1>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1"><?php echo e($types[$option->type]); ?></p>
        </div>

        <form method="POST" action="<?php echo e(route('admin.product-options.update', $option->id)); ?>" class="p-6 space-y-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('name', $option->name)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('price', $option->price)); ?>"
                           placeholder="0.00">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" id="cost" name="cost" step="0.01" min="0"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-lg text-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 transition-all <?php $__errorArgs = ['cost'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 dark:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('cost', $option->cost ?? '0.00')); ?>"
                           placeholder="0.00">
                            ...
                            <?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center mb-2 last:mb-0">
                                    <input type="checkbox" 
                                           ...
                                           <?php echo e(in_array($parent->id, old('parent_ids', $option->parents->pluck('id')->toArray())) ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('order', $option->order)); ?>"
                           placeholder="0">
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input type="checkbox" id="active" name="active" value="1" 
                                   <?php echo e(old('active', $option->active) ? 'checked' : ''); ?>
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input type="checkbox" id="is_pinned" name="is_pinned" value="1" 
                                   <?php echo e(old('is_pinned', $option->is_pinned) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/admin/product-options/edit.blade.php ENDPATH**/ ?>