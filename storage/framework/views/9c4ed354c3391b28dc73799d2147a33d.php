...
<div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-4">
        ...
        <div class="text-2xl font-bold text-orange-600 dark:text-orange-400"><?php echo e($stats['pendentes']); ?></div>
    </div>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-4">
        <div class="text-sm text-gray-600 dark:text-gray-400">Aprovados</div>
        <div class="text-2xl font-bold text-green-600 dark:text-green-400"><?php echo e($stats['aprovados']); ?></div>
    </div>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-4">
        <div class="text-sm text-gray-600 dark:text-gray-400">Total Pendente</div>
        <div class="text-2xl font-bold text-gray-900 dark:text-gray-100">R$ <?php echo e(number_format($stats['total_pendente'], 2, ',', '.')); ?></div>
    </div>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-4">
...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-6 mb-6">
    <form method="GET" action="<?php echo e(route('cash.approvals.index')); ?>" class="space-y-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                ...
                <select name="status" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all text-sm">
                    ...
                    <option value="aprovado" <?php echo e($status == 'aprovado' ? 'selected' : ''); ?>>Aprovados</option>
                    <option value="todos" <?php echo e($status == 'todos' ? 'selected' : ''); ?>>Todos</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select name="type" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all text-sm">
                    <option value="todos" <?php echo e($type == 'todos' ? 'selected' : ''); ?>>Todos</option>
                    <option value="pedidos" <?php echo e($type == 'pedidos' ? 'selected' : ''); ?>>Pedidos</option>
                    <option value="vendas" <?php echo e($type == 'vendas' ? 'selected' : ''); ?>>Vendas</option>
                </select>
            </div>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                ...
                ?>
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 <?php echo e($payment && $payment->cash_approved ? 'bg-green-50 dark:bg-green-900/10' : ''); ?>">
                    <td class="px-4 py-4 whitespace-nowrap">
                        <?php if($payment && !$payment->cash_approved): ?>
                        <input type="checkbox" 
                    ...
                    <td class="px-4 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900 dark:text-gray-100">
                            <?php echo e($order->client?->name ?? 'Sem cliente'); ?>
                    ...
                    <td class="px-4 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900 dark:text-gray-100">
                            R$ <?php echo e(number_format($payment->entry_amount ?? 0, 2, ',', '.')); ?>

                        </div>
                        <?php if($payment && $payment->remaining_amount > 0): ?>
                        <div class="text-xs text-red-600 dark:text-red-400">
                            Restante: R$ <?php echo e(number_format($payment->remaining_amount, 2, ',', '.')); ?>
                        ...
                        <?php if($payment): ?>
                            ...
                            <?php else: ?>
                                <span class="px-2 py-1 text-xs font-semibold rounded-full bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300">
                                    <?php echo e(ucfirst($payment->payment_method ?? $payment->method ?? 'N/A')); ?>
                    ...
                    <td class="px-4 py-4 whitespace-nowrap">
                        <?php if($payment && $payment->receipt_attachment): ?>
                            <a href="<?php echo e(route('cash.approvals.view-receipt', $order->id)); ?>" 
                               target="_blank"
                               class="text-indigo-600 dark:text-indigo-400 hover:underline text-sm">
                                Ver Comprovante
                            </a>
                            <button onclick="removeReceipt(<?php echo e($order->id); ?>)" 
                    ...
                    <td class="px-4 py-4 whitespace-nowrap">
                        <?php if($payment && $payment->cash_approved): ?>
                            ...
                            <?php if($payment->approvedBy): ?>
                            <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                Por: <?php echo e($payment->approvedBy->name); ?>

                            </div>
                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                <?php echo e($payment->approved_at?->format('d/m/Y H:i')); ?>
                    ...
                    <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                        <?php if($payment && !$payment->cash_approved): ?>
                        <button onclick="approveOrder(<?php echo e($order->id); ?>)" 
...
<?php if($status == 'pendente' || $status == 'todos'): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/cash/approvals.blade.php ENDPATH**/ ?>