...
<div class="max-w-4xl mx-auto">
    ...
    <nav class="flex items-center text-sm text-gray-500 dark:text-gray-400 mb-6">
        <a href="<?php echo e(route('admin.personalization-prices.index')); ?>" class="hover:text-indigo-600 dark:hover:text-indigo-400">
            Preços de Personalização
        </a>
        <svg class="w-4 h-4 mx-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
        </svg>
        <span class="text-gray-900 dark:text-gray-100"><?php echo e($setting->display_name); ?></span>
    </nav>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-gray-900/25 border border-gray-200 dark:border-gray-700 mb-6">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Configurações - <?php echo e($setting->display_name); ?></h1>
        ...
        <!-- Form -->
        <form action="<?php echo e(route('admin.personalization-settings.update', $setting->personalization_type)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="display_name" value="<?php echo e(old('display_name', $setting->display_name)); ?>" 
                    ...
                    <div class="flex items-end">
                        <label class="flex items-center">
                            <input type="checkbox" name="active" value="1" <?php echo e($setting->active ? 'checked' : ''); ?>
                ...
                <div>
                    ...
                    <textarea name="description" rows="2" 
                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500"><?php echo e(old('description', $setting->description)); ?></textarea>
                </div>
                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                    ...
                    <div class="space-y-4">
                        <label class="flex items-center">
                            <input type="checkbox" name="charge_by_color" value="1" <?php echo e($setting->charge_by_color ? 'checked' : ''); ?>
                        ...
                        <div id="color-pricing-fields" class="<?php echo e($setting->charge_by_color ? '' : 'hidden'); ?>">
                            <div class="grid grid-cols-4 gap-4">
                                <div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <input type="number" step="0.01" name="color_price_per_unit" value="<?php echo e(old('color_price_per_unit', $setting->color_price_per_unit)); ?>" 
                                               class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500">
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="flex items-center">
                                        <span class="text-sm text-gray-500 dark:text-gray-400 mr-1">R$</span>
                                        <input type="number" step="0.01" name="color_cost_per_unit" value="<?php echo e(old('color_cost_per_unit', $setting->color_cost_per_unit)); ?>" 
                                ...
                                <div>
                                    ...
                                    <input type="number" name="min_colors" value="<?php echo e(old('min_colors', $setting->min_colors)); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500">
                                </div>
                                <div>
                                    <label class="block text-xs text-gray-500 dark:text-gray-400 mb-1">Cores máximas</label>
                                    <input type="number" name="max_colors" value="<?php echo e(old('max_colors', $setting->max_colors)); ?>" placeholder="∞"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <input type="number" step="0.01" name="discount_2nd_application" 
                                       value="<?php echo e(old('discount_2nd_application', $setting->discount_2nd_application)); ?>" 
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500">
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <input type="number" step="0.01" name="discount_3rd_application" 
                                       value="<?php echo e(old('discount_3rd_application', $setting->discount_3rd_application)); ?>" 
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500">
                                <span class="text-sm text-gray-500 dark:text-gray-400 ml-1">%</span>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="flex items-center">
                                <input type="number" step="0.01" name="discount_4th_plus_application" 
                                       value="<?php echo e(old('discount_4th_plus_application', $setting->discount_4th_plus_application)); ?>" 
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500">
                                <span class="text-sm text-gray-500 dark:text-gray-400 ml-1">%</span>
                            </div>
                        </div>
                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <label class="flex items-center">
                            <input type="checkbox" name="has_sizes" value="1" <?php echo e($setting->has_sizes ? 'checked' : ''); ?>

                                   class="w-4 h-4 text-indigo-600 border-gray-300 dark:border-gray-600 rounded focus:ring-indigo-500">
                            <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Usa tamanhos</span>
                        </label>
                        <label class="flex items-center">
                            <input type="checkbox" name="has_locations" value="1" <?php echo e($setting->has_locations ? 'checked' : ''); ?>

                                   class="w-4 h-4 text-indigo-600 border-gray-300 dark:border-gray-600 rounded focus:ring-indigo-500">
                            <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Usa locais</span>
                        </label>
                        <label class="flex items-center">
                            <input type="checkbox" name="has_special_options" value="1" <?php echo e($setting->has_special_options ? 'checked' : ''); ?>
            ...
            <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 flex justify-between items-center">
                <a href="<?php echo e(route('admin.personalization-prices.index')); ?>" 
                   class="px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100">
                    ← Voltar
                </a>
                <button type="submit" 
                        class="px-6 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-gray-900/25 border border-gray-200 dark:border-gray-700">
        ...
        <div class="p-6">
            ...
            <div class="space-y-3 mb-6">
                <?php $__empty_1 = true; $__currentLoopData = $specialOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-700 rounded-lg">
                    <div class="flex items-center space-x-3">
                        <div>
                            <div class="font-medium text-gray-900 dark:text-gray-100"><?php echo e($option->name); ?></div>
                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                <?php echo e($option->charge_type === 'percentage' ? 'Percentual' : 'Valor Fixo'); ?>: 
                                <span class="text-green-600 dark:text-green-400 font-semibold"><?php echo e($option->formatted_value); ?></span>
                                <span class="text-gray-300 dark:text-gray-600 mx-2">|</span>
                                Custo: <span class="text-red-500 dark:text-red-400">R$ <?php echo e(number_format($option->cost, 2, ',', '.')); ?></span>
                                <?php if($option->description): ?>
                                    <span class="ml-2">• <?php echo e($option->description); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    <div class="flex items-center space-x-2">
                        <form action="<?php echo e(route('admin.personalization-settings.special-options.toggle', [$setting->personalization_type, $option->id])); ?>" method="POST" class="inline">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PATCH'); ?>
                            <button type="submit" class="px-3 py-1.5 text-xs font-semibold rounded-lg border <?php echo e($option->active ? 'border-green-300 text-green-700 bg-green-50 dark:border-green-700 dark:text-green-200 dark:bg-green-900/30' : 'border-gray-300 text-gray-600 bg-white dark:border-gray-600 dark:text-gray-200 dark:bg-gray-700'); ?>">
                                <?php echo e($option->active ? 'Ativa' : 'Inativa'); ?>

                            </button>
                        </form>
                        <form id="delete-form-<?php echo e($option->id); ?>" action="<?php echo e(route('admin.personalization-settings.special-options.destroy', [$setting->personalization_type, $option->id])); ?>" method="POST" class="inline">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="button" onclick="openDeleteModal('<?php echo e($option->id); ?>', '<?php echo e($option->name); ?>')" class="p-2 text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20 rounded-lg transition-colors">
            ...
            <form action="<?php echo e(route('admin.personalization-settings.special-options.store', $setting->personalization_type)); ?>" method="POST" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-5 gap-3">
                    ...
                    <div>
                        <button type="submit" 
                                class="w-full px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors flex items-center justify-center">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/admin/personalization-prices/settings.blade.php ENDPATH**/ ?>