...
<head>
    ...
    <title>Recuperar Senha - <?php echo e(config('app.name', 'Vestalize')); ?></title>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                required 
                                autofocus
                                class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-center mt-8 text-indigo-100 text-sm">
                <p>&copy; <?php echo e(date('Y')); ?> Vestalize. Todos os direitos reservados.</p>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>