...
<aside id="sidebar" 
    ...
    <div class="flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        <div class="flex items-center overflow-hidden" x-show="expanded">
            <?php if(auth()->user()->tenant && auth()->user()->tenant->logo_path): ?>
                <img src="<?php echo e(Storage::url(auth()->user()->tenant->logo_path)); ?>" alt="Logo" class="h-8 w-auto object-contain">
            <?php else: ?>
                <h1 class="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 whitespace-nowrap">
                    <?php echo e(auth()->user()->tenant->name ?? 'Vestalize'); ?>
    ...
    <nav class="flex flex-col px-2 py-4 space-y-1 overflow-y-auto h-[calc(100vh-8rem)] scrollbar-thin">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" 
           class="flex items-center px-3 py-2.5 text-sm font-medium rounded-md transition-all duration-200 <?php echo e(request()->is('dashboard*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-blue-600 dark:hover:text-blue-400'); ?>"
        ...
        <?php if(Auth::user()->isEstoque() && !Auth::user()->isAdmin()): ?>
            ...
            <!-- ... Itens estoque ... -->
             <a href="<?php echo e(route('stocks.index')); ?>" 
               class="flex items-center px-3 py-2.5 text-sm font-medium rounded-md transition-all duration-200 <?php echo e(request()->is('stocks*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
               :class="expanded ? 'justify-start' : 'justify-center'">
             ...
             <a href="<?php echo e(route('stock-requests.index')); ?>" 
               class="flex items-center px-3 py-2.5 text-sm font-medium rounded-md transition-all duration-200 <?php echo e(request()->is('stock-requests*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
               :class="expanded ? 'justify-start' : 'justify-center'">
             ...
             <a href="<?php echo e(route('sewing-machines.index')); ?>" 
               class="flex items-center px-3 py-2.5 text-sm font-medium rounded-md transition-all duration-200 <?php echo e(request()->is('sewing-machines*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
               :class="expanded ? 'justify-start' : 'justify-center'">
             ...
             <a href="<?php echo e(route('production-supplies.index')); ?>" 
               class="flex items-center px-3 py-2.5 text-sm font-medium rounded-md transition-all duration-200 <?php echo e(request()->is('production-supplies*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
               :class="expanded ? 'justify-start' : 'justify-center'">
               <svg class="flex-shrink-0 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
                <span class="ml-3" x-show="expanded">Suprimentos</span>
            </a>
             <a href="<?php echo e(route('uniforms.index')); ?>" 
               class="flex items-center px-3 py-2.5 text-sm font-medium rounded-md transition-all duration-200 <?php echo e(request()->is('uniforms*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
               :class="expanded ? 'justify-start' : 'justify-center'">
        ...
        <?php else: ?>
            ...
            <div class="mt-2">
                ...
                <div x-show="openGroups.vendas && expanded" x-collapse x-cloak class="space-y-1 mt-1 bg-gray-50 dark:bg-gray-900/50 rounded-md overflow-hidden">
                    <a href="<?php echo e(route('orders.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('pedidos*') ? 'bg-blue-600' : ''); ?>"></span>
                        Pedidos
                    </a>
                    <a href="<?php echo e(route('budget.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('orcamento*') ? 'bg-blue-600' : ''); ?>"></span>
                        Orçamentos
                    </a>
                    <?php if(Auth::user()->tenant?->canAccess('external_quote')): ?>
                    <a href="<?php echo e(route('admin.quote-settings.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('admin/quote-settings*') ? 'bg-blue-600' : ''); ?>"></span>
                        Link de Orçamento
                    </a>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('clients.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('clientes*') ? 'bg-blue-600' : ''); ?>"></span>
                        Clientes
                    </a>
                    <?php if(Auth::user()->tenant?->canAccess('kanban')): ?>
                    <a href="<?php echo e(route('kanban.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('kanban*') ? 'bg-blue-600' : ''); ?>"></span>
                        Kanban
                    </a>
                    <?php endif; ?>
                </div>
            ...
            <div class="mt-1">
                ...
                <div x-show="openGroups.estoque && expanded" x-collapse x-cloak class="space-y-1 mt-1 bg-gray-50 dark:bg-gray-900/50 rounded-md overflow-hidden">
                    <a href="<?php echo e(route('stocks.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('stocks*') ? 'bg-blue-600' : ''); ?>"></span>
                        Geral
                    </a>
                    <a href="<?php echo e(route('fabric-pieces.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('fabric-pieces*') ? 'bg-blue-600' : ''); ?>"></span>
                        Peças de Tecido
                    </a>
                    <a href="<?php echo e(route('sewing-machines.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('sewing-machines*') ? 'bg-blue-600' : ''); ?>"></span>
                        Máq. Costura
                    </a>
                    <a href="<?php echo e(route('production-supplies.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('production-supplies*') ? 'bg-blue-600' : ''); ?>"></span>
                        Suprimentos
                    </a>
                    <a href="<?php echo e(route('uniforms.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('uniforms*') ? 'bg-blue-600' : ''); ?>"></span>
                        Uniformes/EPI
                    </a>
                    <a href="<?php echo e(route('stock-requests.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('stock-requests*') ? 'bg-blue-600' : ''); ?>"></span>
                        Solicitações
                    </a>
                </div>
            </div>
            ...
            <div class="mt-1">
                ...
                <div x-show="openGroups.producao && expanded" x-collapse x-cloak class="space-y-1 mt-1 bg-gray-50 dark:bg-gray-900/50 rounded-md overflow-hidden">
                    <a href="<?php echo e(route('production.dashboard')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('production/dashboard*') ? 'bg-blue-600' : ''); ?>"></span>
                        Dashboard
                    </a>
                    <a href="<?php echo e(route('production.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('producao*') && !request()->is('production/dashboard*') ? 'bg-blue-600' : ''); ?>"></span>
                        Ordens
                    </a>
                </div>
            </div>
            ...
            <div class="mt-1">
                ...
                <div x-show="openGroups.financeiro && expanded" x-collapse x-cloak class="space-y-1 mt-1 bg-gray-50 dark:bg-gray-900/50 rounded-md overflow-hidden">
                    <a href="<?php echo e(route('financial.dashboard')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('financeiro*') ? 'bg-green-600' : ''); ?>"></span>
                        Dashboard
                    </a>
            ...
            <div class="mt-2">
                <a href="<?php echo e(route('subscription.index')); ?>"
                   class="flex items-center w-full px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 group
                          <?php echo e(request()->is('subscription*') 
                             ? 'bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300' 
                             : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700'); ?>"
                   :class="expanded ? 'justify-start' : 'justify-center'">
                    <svg class="flex-shrink-0 h-5 w-5 <?php echo e(request()->is('subscription*') ? 'text-indigo-600' : 'text-gray-500 group-hover:text-indigo-600 dark:text-gray-400 dark:group-hover:text-indigo-400'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <?php if(Auth::user()->isAdmin() && Auth::user()->tenant_id === null): ?>
            <div class="mt-1">
                ...
                <div x-show="openGroups.assinaturas && expanded" x-collapse x-cloak class="space-y-1 mt-1 bg-gray-50 dark:bg-gray-900/50 rounded-md overflow-hidden">
                    <a href="<?php echo e(route('admin.tenants.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('admin/tenants*') ? 'bg-indigo-600' : ''); ?>"></span>
                        Gerenciar
                    </a>
                    <a href="<?php echo e(route('admin.plans.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('admin/plans*') ? 'bg-indigo-600' : ''); ?>"></span>
                        Planos
                    </a>
                    <a href="<?php echo e(route('admin.subscription-payments.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
            ...
            <div class="mt-1">
                 ...
                 <div x-show="openGroups.sistema && expanded" x-collapse x-cloak class="space-y-1 mt-1 bg-gray-50 dark:bg-gray-900/50 rounded-md overflow-hidden">
                    ...
                    <a href="<?php echo e(route('settings.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                         <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-2 <?php echo e(request()->is('settings*') ? 'bg-purple-600' : ''); ?>"></span>
                        Configurações
                    </a>
                    <?php endif; ?>
                     <a href="<?php echo e(route('links.index')); ?>" class="flex items-center pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition">
            ...
            <div class="mt-6 space-y-4">
                ...
                <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e(auth()->user()->store); ?></p>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e(auth()->user()->created_at->format('d/m/Y')); ?></p>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/components/app-sidebar.blade.php ENDPATH**/ ?>