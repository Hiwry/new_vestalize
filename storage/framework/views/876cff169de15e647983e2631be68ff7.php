...
<div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
    ...
    <a href="<?php echo e(route('orders.wizard.start')); ?>" 
                ...
                <div>
                    ...
                    <select name="status" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-indigo-500 dark:focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 dark:focus:ring-indigo-500 transition-all text-sm">
                        ...
                        <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($s->id); ?>" <?php echo e($status == $s->id ? 'selected' : ''); ?>>
                                <?php echo e($s->name); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <select name="date_type" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-indigo-500 dark:focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 dark:focus:ring-indigo-500 transition-all text-sm">
                            <option value="created" <?php echo e(($dateType ?? 'created') == 'created' ? 'selected' : ''); ?>>Data de Criação</option>
                            <option value="delivery" <?php echo e(($dateType ?? 'created') == 'delivery' ? 'selected' : ''); ?>>Data de Entrega</option>
                        </select>
                    </div>
                    ...
                    <div class="flex items-end">
                        <div class="w-full space-y-2">
                            ...
                            <a href="<?php echo e(route('orders.index')); ?>" class="block w-full px-6 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-md hover:bg-gray-300 dark:hover:bg-gray-600 text-center transition">
                                Limpar
                            </a>
                        </div>
                    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 relative overflow-hidden">
        ...
        <div class="pl-2">
            ...
            <div class="flex justify-between items-start mb-3">
                <div>
                    <span class="text-xs font-bold text-gray-500 dark:text-gray-400">#<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?></span>
                    <h3 class="font-semibold text-gray-900 dark:text-gray-100"><?php echo e($order->client ? $order->client->name : 'Sem cliente'); ?></h3>
                </div>
            ...
            <div class="mb-3 space-y-1">
                ...
                <div class="flex items-center text-sm text-gray-600 dark:text-gray-300">
                    ...
                    <span class="truncate"><?php echo e($artName); ?></span>
                </div>
                <?php endif; ?>
                ...
                <div class="flex items-center text-sm text-gray-600 dark:text-gray-300">
                    ...
                    <span><?php echo e($order->items->sum('quantity')); ?> peças</span>
                </div>
            ...
            <div class="flex justify-end items-center gap-3 pt-3 border-t border-gray-100 dark:border-gray-700 mt-3">
                 <a href="<?php echo e(route('orders.show', $order->id)); ?>" class="flex-1 text-center py-2 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 text-sm font-medium rounded-lg">
                    Ver Detalhes
                </a>
            </div>
        </div>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition <?php echo e($order->is_cancelled ? 'bg-red-50 dark:bg-red-900/20' : ''); ?>">
                    <td class="px-4 py-4 whitespace-nowrap">
                        <div class="text-sm font-medium <?php echo e($order->is_cancelled ? 'text-red-600 dark:text-red-400 line-through' : 'text-gray-900 dark:text-gray-100'); ?>">
                    ...
                    <td class="px-4 py-4">
                        <?php if($order->client): ?>
                        <div class="text-sm text-gray-900 dark:text-gray-100 font-medium max-w-[200px] truncate <?php echo e($order->is_cancelled ? 'opacity-50' : ''); ?>" title="<?php echo e($order->client->name); ?>">
                            <?php echo e($order->client->name); ?>

                        </div>
                        <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($order->client->phone_primary); ?></div>
                        <?php else: ?>
                        <div class="text-sm text-gray-500 dark:text-gray-400 italic <?php echo e($order->is_cancelled ? 'opacity-50' : ''); ?>">
                    ...
                    <td class="px-4 py-4">
                        ...
                        ?>
                        <?php if($artName): ?>
                            <div class="text-sm text-gray-900 dark:text-gray-100 <?php echo e($order->is_cancelled ? 'opacity-50' : ''); ?>">
                                <span class="block max-w-[200px] truncate" title="<?php echo e($artName); ?>"><?php echo e($artName); ?></span>
                            </div>
                        <?php else: ?>
                    ...
                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 text-center">
                        <?php echo e($order->items->sum('quantity')); ?> peças
                    </td>
                    ...
                    <td class="px-4 py-4 whitespace-nowrap">
                        <div class="flex items-center justify-center space-x-2">
                            ...
                            <?php if(!$order->is_cancelled && !$order->has_pending_cancellation): ?>
                            <button onclick="openCancellationModal(<?php echo e($order->id); ?>)" 
                            ...
                            <?php if(!$order->is_cancelled): ?>
                                ...
                                <?php if(Auth::user()->isAdmin()): ?>
                                    ...
                                    <a href="<?php echo e(route('orders.edit.start', $order->id)); ?>" 
                                ...
                                <?php elseif($approvedEditRequest): ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <button onclick="openEditRequestModal(<?php echo e($order->id); ?>)" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/orders/index.blade.php ENDPATH**/ ?>