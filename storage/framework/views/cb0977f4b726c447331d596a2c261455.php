                ...
                <div class="p-4 bg-gray-50 dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 hover:border-indigo-400 dark:hover:border-indigo-600 transition-colors">
                    <div class="flex justify-between items-start mb-3">
                        ...
                        <div class="flex gap-1">
                            <button type="button" onclick="togglePin(<?php echo e($item->id); ?>)" class="p-1 <?php echo e($item->is_pinned ? 'text-yellow-500 hover:text-yellow-600' : 'text-gray-400 hover:text-yellow-500'); ?> transition-colors" title="<?php echo e($item->is_pinned ? 'Desafixar do topo' : 'Fixar no topo'); ?>">
                                <svg class="w-4 h-4" fill="<?php echo e($item->is_pinned ? 'currentColor' : 'none'); ?>" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button type="button" onclick="openDeleteModal(<?php echo e($item->id); ?>)" class="p-1 text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 transition-colors" title="Remover item">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/orders/wizard/partials/items_sidebar.blade.php ENDPATH**/ ?>