...
<div class="max-w-[1800px] mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-3">
            ...
            <a href="<?php echo e(route('cash.create')); ?>" 
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-6 border-l-4 border-blue-500 dark:border-blue-600">
            ...
            <p class="text-3xl font-bold <?php echo e($saldoAtual >= 0 ? 'text-blue-600 dark:text-blue-400' : 'text-red-600 dark:text-red-400'); ?>">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-4 mb-6">
        <form method="GET" action="<?php echo e(route('cash.index')); ?>" class="grid grid-cols-1 md:grid-cols-5 gap-3">
            <div>
            ...
            <div>
                ...
                <select name="type" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-indigo-500 dark:focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 dark:focus:ring-indigo-500 transition-all text-sm">
                    <option value="all" <?php echo e($type === 'all' ? 'selected' : ''); ?>>Todos</option>
                    <option value="entrada" <?php echo e($type === 'entrada' ? 'selected' : ''); ?>>Entradas</option>
                    <option value="saida" <?php echo e($type === 'saida' ? 'selected' : ''); ?>>Saídas</option>
                </select>
            </div>
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="<?php echo e(route('cash.index')); ?>" class="flex-1 px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-300 dark:hover:bg-gray-600 text-center transition text-sm">
                    Limpar
                </a>
            </div>
        </form>
...
Visualização em Grid (até 8 notas por linha) -->
    <div class="mb-6">
        ...
        <div id="view-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-4">
            <?php $__empty_1 = true; $__currentLoopData = $confirmadas->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition overflow-hidden">
                <div class="p-4">
                    <div class="flex justify-between items-start mb-3">
                        ...
                        <span class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($transaction->transaction_date->format('d/m/Y H:i')); ?></span>
                    </div>
                    
                    <h3 class="text-sm font-medium text-gray-900 dark:text-white mb-1"><?php echo e($transaction->category); ?></h3>
                    <p class="text-xs text-gray-600 dark:text-gray-400 mb-3 line-clamp-2"><?php echo e($transaction->description); ?></p>
                    ...
                    <div class="mb-3 space-y-1">
                        ...
                        <div class="flex justify-between text-xs">
                            <span class="text-gray-600 dark:text-gray-400 capitalize"><?php echo e($method['method'] ?? $transaction->payment_method); ?></span>
                            <span class="font-medium text-gray-900 dark:text-white">R$ <?php echo e(number_format($method['amount'] ?? $transaction->amount, 2, ',', '.')); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    
                    <div class="flex justify-between items-center pt-3 border-t border-gray-100 dark:border-gray-700">
                        <span class="text-lg font-bold <?php echo e($transaction->type === 'entrada' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                            <?php echo e($transaction->type === 'entrada' ? '+' : '-'); ?> R$ <?php echo e(number_format($transaction->amount, 2, ',', '.')); ?>

                        </span>
                        <?php if($transaction->order_id): ?>
                        <a href="<?php echo e(route('orders.show', $transaction->order_id)); ?>" class="text-xs text-blue-600 dark:text-blue-400 hover:underline">
                    ...
                    <div class="mt-2 flex justify-between items-center text-xs text-gray-500 dark:text-gray-400">
                        <span>Vendedor: <?php echo e($transaction->user_name ?? 'Sistema'); ?></span>
                        <a href="<?php echo e(route('cash.edit', $transaction)); ?>" class="text-indigo-600 dark:text-indigo-400 hover:underline">Editar</a>
                    </div>
                </div>
            </div>
        ...
        <div id="view-kanban" class="hidden grid grid-cols-1 md:grid-cols-4 gap-4 overflow-x-auto pb-4">
            ...
            <div class="bg-orange-50 dark:bg-orange-900/10 rounded-lg border-2 border-orange-200 dark:border-orange-800/30 min-h-96 flex-shrink-0" style="min-width: 280px;">
                <div class="px-4 py-3 bg-orange-500 dark:bg-orange-600 rounded-t-md">
                    <h3 class="font-semibold text-white flex items-center justify-between">
                        <span>⏳ Pendente</span>
                        <span class="text-sm bg-white/20 px-2 py-1 rounded"><?php echo e($pendentes->count()); ?></span>
                    </h3>
                    <p class="text-xs text-white/80 mt-1">Total: R$ <?php echo e(number_format($totalPendentes, 2, ',', '.')); ?></p>
                </div>
                <div class="p-3 space-y-3 max-h-[600px] overflow-y-auto">
                    <?php $__empty_1 = true; $__currentLoopData = $pendentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php echo $__env->make('cash.partials.transaction-card', ['transaction' => $transaction], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="bg-blue-50 dark:bg-blue-900/10 rounded-lg border-2 border-blue-200 dark:border-blue-800/30 min-h-96 flex-shrink-0" style="min-width: 280px;">
                <div class="px-4 py-3 bg-blue-500 dark:bg-blue-600 rounded-t-md">
                    <h3 class="font-semibold text-white flex items-center justify-between">
                        ...
                        <span class="text-sm bg-white/20 px-2 py-1 rounded"><?php echo e($confirmadas->count()); ?></span>
                    </h3>
                    <p class="text-xs text-white/80 mt-1">Saldo: R$ <?php echo e(number_format($totalConfirmadas, 2, ',', '.')); ?></p>
                </div>
                <div class="p-3 space-y-3 max-h-[600px] overflow-y-auto">
                    <?php $__empty_1 = true; $__currentLoopData = $confirmadas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php echo $__env->make('cash.partials.transaction-card', ['transaction' => $transaction], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="bg-red-50 dark:bg-red-900/10 rounded-lg border-2 border-red-200 dark:border-red-800/30 min-h-96 flex-shrink-0" style="min-width: 280px;">
                <div class="px-4 py-3 bg-red-500 dark:bg-red-600 rounded-t-md">
                    <h3 class="font-semibold text-white flex items-center justify-between">
                        <span>✕ Cancelado</span>
                        <span class="text-sm bg-white/20 px-2 py-1 rounded"><?php echo e($canceladas->count()); ?></span>
                    </h3>
                    <p class="text-xs text-white/80 mt-1">Total: R$ <?php echo e(number_format($totalCanceladas, 2, ',', '.')); ?></p>
                </div>
                <div class="p-3 space-y-3 max-h-[600px] overflow-y-auto">
                    <?php $__empty_1 = true; $__currentLoopData = $canceladas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php echo $__env->make('cash.partials.transaction-card', ['transaction' => $transaction], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="bg-purple-50 dark:bg-purple-900/10 rounded-lg border-2 border-purple-200 dark:border-purple-800/30 min-h-96 flex-shrink-0" style="min-width: 280px;">
                <div class="px-4 py-3 bg-purple-500 dark:bg-purple-600 rounded-t-md">
                    <h3 class="font-semibold text-white flex items-center justify-between">
                        <span>💸 Sangria</span>
                        <span class="text-sm bg-white/20 px-2 py-1 rounded"><?php echo e($sangrias->count()); ?></span>
                    </h3>
                    <p class="text-xs text-white/80 mt-1">Total: R$ <?php echo e(number_format($totalSangrias, 2, ',', '.')); ?></p>
                </div>
                <div class="p-3 space-y-3 max-h-[600px] overflow-y-auto">
                    <?php $__empty_1 = true; $__currentLoopData = $sangrias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php echo $__env->make('cash.partials.transaction-card', ['transaction' => $transaction], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<div id="modal-report-simplified" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
    <div class="relative top-10 mx-auto p-5 border border-gray-200 dark:border-gray-700 w-full max-w-4xl shadow-lg dark:shadow-gray-900/25 rounded-md bg-white dark:bg-gray-800 mb-10">
        ...
        <div class="mb-4">
            ...
            <input type="date" id="report-simplified-date" value="<?php echo e(date('Y-m-d')); ?>" 
                   class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-indigo-500 dark:focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 dark:focus:ring-indigo-500 transition-all text-sm">
    ...
    <div class="relative top-10 mx-auto p-5 border border-gray-200 dark:border-gray-700 w-full max-w-6xl shadow-lg dark:shadow-gray-900/25 rounded-md bg-white dark:bg-gray-800 mb-10">
        ...
        <div class="mb-4 grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="date" id="report-detailed-start" value="<?php echo e($startDate); ?>" 
                       class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-indigo-500 dark:focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 dark:focus:ring-indigo-500 transition-all text-sm">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Data Final</label>
                <input type="date" id="report-detailed-end" value="<?php echo e($endDate); ?>" 
                       class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-indigo-500 dark:focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 dark:focus:ring-indigo-500 transition-all text-sm">
            </div>
...
<script>
    ...
    function loadSimplifiedReport() {
        ...
        fetch(`<?php echo e(route('cash.report.simplified')); ?>?date=${date}`)
            .then(response => {
                if (!response.ok) {
    ...
    function loadDetailedReport() {
        ...
        fetch(`<?php echo e(route('cash.report.detailed')); ?>?start_date=${startDate}&end_date=${endDate}`)
            .then(response => {
                if (!response.ok) {
                    throw new Error(`HTTP error! status: ${response.status}`);
                }
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/cash/index.blade.php ENDPATH**/ ?>