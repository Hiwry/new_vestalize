        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white dark:bg-slate-900 rounded-xl shadow-xl dark:shadow-2xl dark:shadow-black/20 border border-gray-200 dark:border-slate-800 overflow-hidden">
                    ...
                    <div class="p-6">
                        <form method="POST" action="<?php echo e(isset($editData) ? route('orders.edit.sewing') : route('orders.wizard.sewing')); ?>" data-action-url="<?php echo e(isset($editData) ? route('orders.edit.sewing') : route('orders.wizard.sewing')); ?>" id="sewing-form" class="space-y-5" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
            ...
            <div class="lg:col-span-1" id="items-sidebar-container">
                <?php echo $__env->make('orders.wizard.partials.items_sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    </div>
...
<script>
        ...
        let itemsData = <?php echo json_encode($order->items->toArray()); ?>;
        ...
        async function confirmDelete() {
            ...
            try {
                ...
                const response = await fetch("<?php echo e(route('orders.wizard.sewing')); ?>", {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/orders/wizard/sewing.blade.php ENDPATH**/ ?>