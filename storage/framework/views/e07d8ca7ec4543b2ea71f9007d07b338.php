...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-2xl dark:shadow-black/20 border border-gray-200 dark:border-gray-700">
    ...
    <div class="p-6">
        <?php if($order->editHistory->count() > 0): ?>
            <div class="space-y-4">
                <?php $__currentLoopData = $order->editHistory->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-start space-x-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="flex-shrink-0">
                        <div class="w-8 h-8 rounded-full flex items-center justify-center
                            <?php if($history->action === 'finalize'): ?> bg-green-100 text-green-600
                            <?php elseif($history->action === 'client_changes'): ?> bg-blue-100 text-blue-600
                            <?php elseif($history->action === 'item_changes'): ?> bg-purple-100 text-purple-600
                            <?php elseif($history->action === 'payment_changes'): ?> bg-yellow-100 text-yellow-600
                            <?php else: ?> bg-gray-100 text-gray-600
                            <?php endif; ?>">
                            <?php if($history->action === 'finalize'): ?>
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                </svg>
                            <?php elseif($history->action === 'client_changes'): ?>
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                </svg>
                            <?php elseif($history->action === 'item_changes'): ?>
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                                </svg>
                            <?php elseif($history->action === 'payment_changes'): ?>
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center justify-between gap-4">
                            <h4 class="text-sm font-medium text-gray-900 dark:text-white break-words"><?php echo e($history->description); ?></h4>
                            <time class="text-xs text-gray-500 dark:text-slate-400 whitespace-nowrap flex-shrink-0" datetime="<?php echo e($history->created_at); ?>">
                        ...
                        <p class="text-xs text-gray-600 dark:text-slate-400 mt-1 break-words">
                            Por: <span class="font-medium"><?php echo e($history->user_name); ?></span>
                        </p>
                        ...
                        <?php if(!empty($changes) && is_array($changes) && count($changes) > 0): ?>
                        <div class="mt-3">
                            <details class="group">
                                ...
                                <div class="mt-3">
                                    ...
                                    <?php if(isset($changes['order']) && !empty($changes['order'])): ?>
                                        <div class="bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-950/50 dark:to-blue-950/50 rounded-lg p-4 border border-indigo-200 dark:border-indigo-800">
                                            ...
                                            <div class="space-y-2">
                                <?php $__currentLoopData = $changes['order']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $change): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(is_array($change) && isset($change['old']) && isset($change['new'])): ?>
                                        <div class="flex items-start justify-between bg-white dark:bg-slate-800 rounded-md p-2 text-xs gap-2">
                                            <span class="font-medium text-gray-700 dark:text-slate-300 flex-shrink-0"><?php echo e(getFieldLabel($field)); ?>:</span>
                                            <div class="text-right flex-1 min-w-0">
                                                <div class="text-red-600 line-through break-words"><?php echo formatChangeValue($change['old'], $field); ?></div>
                                                <div class="text-green-600 font-medium break-words">→ <?php echo formatChangeValue($change['new'], $field); ?></div>
                                            </div>
                                        </div>
                                                    <?php else: ?>
                                                        
                                                        <div class="bg-white dark:bg-gray-700 rounded-md p-2 text-xs text-gray-600 break-words overflow-hidden">
                                                            <span class="font-medium"><?php echo e(getFieldLabel($field)); ?>:</span>
                                                            <span class="ml-2"><?php echo e(is_array($change) ? json_encode($change) : $change); ?></span>
                                                        </div>
                                                    <?php endif; ?>
                                    ...
                                    <?php if(isset($changes['client']) && !empty($changes['client'])): ?>
                                        <div class="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/50 dark:to-pink-950/50 rounded-lg p-4 border border-purple-200 dark:border-purple-800">
                                            ...
                                            <div class="space-y-2">
                                                <?php $__currentLoopData = $changes['client']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $change): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(is_array($change) && isset($change['old']) && isset($change['new'])): ?>
                                                <div class="flex items-start justify-between bg-white dark:bg-gray-700 rounded-md p-2 text-xs gap-2">
                                                    <span class="font-medium text-gray-700 dark:text-gray-400 flex-shrink-0"><?php echo e(getFieldLabel($field)); ?>:</span>
                                                    <div class="text-right flex-1 min-w-0">
                                                        <div class="text-red-600 line-through break-words"><?php echo formatChangeValue($change['old'], $field); ?></div>
                                                        <div class="text-green-600 font-medium break-words">→ <?php echo formatChangeValue($change['new'], $field); ?></div>
                                                    </div>
                                    ...
                                    <?php if(isset($changes['items']) && !empty($changes['items'])): ?>
                                        <div class="bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-950/50 dark:to-amber-950/50 rounded-lg p-4 border border-orange-200 dark:border-orange-800">
                                            ...
                                            <div class="space-y-3">
                                                <?php $__currentLoopData = $changes['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemId => $itemChange): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(is_array($itemChange) && isset($itemChange['type'])): ?>
                                                        <div class="bg-white dark:bg-gray-700 rounded-md p-3 border border-orange-200">
                                                            <?php if($itemChange['type'] === 'modified' && isset($itemChange['changes'])): ?>
                                                                <div class="flex items-center space-x-2 mb-2">
                                                                    <span class="px-2 py-1 bg-blue-100 text-blue-700 text-xs font-medium rounded">✏️ Modificado</span>
                                                                    <span class="text-xs text-gray-500">Item #<?php echo e($itemId); ?></span>
                                                                </div>
                                                                <div class="space-y-2">
                                                                    <?php $__currentLoopData = $itemChange['changes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $change): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php if($field !== 'sublimations' && $field !== 'files' && is_array($change) && isset($change['old']) && isset($change['new'])): ?>
                                                                        <div class="flex items-start justify-between text-xs">
                                                                            <span class="font-medium text-gray-700 dark:text-slate-300 mr-3"><?php echo e(getFieldLabel($field)); ?>:</span>
                                                                            <div class="text-right flex-1">
                                                                                <div class="text-red-600 line-through"><?php echo formatChangeValue($change['old'], $field); ?></div>
                                                                                <div class="text-green-600 font-medium">→ <?php echo formatChangeValue($change['new'], $field); ?></div>
                                                                            </div>
                                                                        </div>
                                                                        <?php endif; ?>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </div>
                                                            <?php elseif($itemChange['type'] === 'added' && isset($itemChange['data'])): ?>
                                                                <div class="flex items-center space-x-2">
                                                                    <span class="px-2 py-1 bg-green-100 text-green-700 text-xs font-medium rounded">✨ Adicionado</span>
                                                                    <span class="text-xs text-gray-700"><?php echo e($itemChange['data']['quantity'] ?? 0); ?> un - <?php echo e($itemChange['data']['print_type'] ?? 'N/A'); ?></span>
                                                                </div>
                                                            <?php elseif($itemChange['type'] === 'removed' && isset($itemChange['data'])): ?>
                                                                <div class="flex items-center space-x-2">
                                            ...
                                            <?php else: ?>
                                                        ...
                                                        <?php if(is_array($itemChange)): ?>
                                                            <div class="bg-white dark:bg-gray-700 rounded-md p-3 border border-orange-200">
                                                                <div class="flex items-center space-x-2 mb-2">
                                                                    <span class="px-2 py-1 bg-gray-100 text-gray-700 text-xs font-medium rounded">📦 Item</span>
                                                                    <span class="text-xs text-gray-500">#<?php echo e($itemId); ?></span>
                                                                </div>
                                                                <div class="grid grid-cols-2 gap-2 text-xs">
                                                                    <?php if(isset($itemChange['quantity'])): ?>
                                                                        <div class="bg-gray-50 dark:bg-gray-700/50 p-2 rounded">
                                                                            <span class="text-gray-600 dark:text-slate-400">Quantidade:</span>
                                                                            <span class="font-medium text-gray-900 dark:text-white ml-1"><?php echo e($itemChange['quantity']); ?></span>
                                                                        </div>
                                                                    <?php endif; ?>
                                                                    <?php if(isset($itemChange['print_type'])): ?>
                                                                        <div class="bg-gray-50 dark:bg-slate-800/50 p-2 rounded">
                                                                            <span class="text-gray-600 dark:text-slate-400">Impressão:</span>
                                                                            <span class="font-medium text-gray-900 dark:text-white ml-1"><?php echo e($itemChange['print_type']); ?></span>
                                                                        </div>
                                                                    <?php endif; ?>
                                                                    <?php if(isset($itemChange['fabric'])): ?>
                                                                        <div class="bg-gray-50 dark:bg-slate-800/50 p-2 rounded">
                                                                            <span class="text-gray-600 dark:text-slate-400">Tecido:</span>
                                                                            <span class="font-medium text-gray-900 dark:text-white ml-1"><?php echo e($itemChange['fabric']); ?></span>
                                                                        </div>
                                                                    <?php endif; ?>
                                                                    <?php if(isset($itemChange['color'])): ?>
                                                                        <div class="bg-gray-50 dark:bg-slate-800/50 p-2 rounded">
                                                                            <span class="text-gray-600 dark:text-slate-400">Cor:</span>
                                                                            <span class="font-medium text-gray-900 dark:text-white ml-1"><?php echo e($itemChange['color']); ?></span>
                                                                        </div>
                                                                    <?php endif; ?>
                                                                    <?php if(isset($itemChange['collar'])): ?>
                                                                        <div class="bg-gray-50 dark:bg-slate-800/50 p-2 rounded">
                                                                            <span class="text-gray-600 dark:text-slate-400">Gola:</span>
                                                                            <span class="font-medium text-gray-900 dark:text-white ml-1"><?php echo e($itemChange['collar']); ?></span>
                                                                        </div>
                                                                    <?php endif; ?>
                                                                    <?php if(isset($itemChange['model'])): ?>
                                                                        <div class="bg-gray-50 dark:bg-slate-800/50 p-2 rounded">
                                                                            <span class="text-gray-600 dark:text-slate-400">Modelo:</span>
                                                                            <span class="font-medium text-gray-900 dark:text-white ml-1"><?php echo e($itemChange['model']); ?></span>
                                                                        </div>
                                                                    <?php endif; ?>
                                                                    <?php if(isset($itemChange['detail'])): ?>
                                                                        <div class="bg-gray-50 dark:bg-slate-800/50 p-2 rounded">
                                                                            <span class="text-gray-600 dark:text-slate-400">Detalhe:</span>
                                                                            <span class="font-medium text-gray-900 dark:text-white ml-1"><?php echo e($itemChange['detail']); ?></span>
                                                                        </div>
                                                                    <?php endif; ?>
                                                                    <?php if(isset($itemChange['unit_price'])): ?>
                                                                        <div class="bg-gray-50 dark:bg-slate-800/50 p-2 rounded">
                                                                            <span class="text-gray-600 dark:text-slate-400">Preço Unit.:</span>
                                                                            <span class="font-medium text-gray-900 dark:text-white ml-1">R$ <?php echo e(number_format((float)$itemChange['unit_price'], 2, ',', '.')); ?></span>
                                                                        </div>
                                                                    <?php endif; ?>
                                                                    <?php if(isset($itemChange['total_price'])): ?>
                                                                        <div class="bg-gray-50 dark:bg-slate-800/50 p-2 rounded">
                                                                            <span class="text-gray-600 dark:text-slate-400">Total:</span>
                                                                            <span class="font-medium text-gray-900 dark:text-white ml-1">R$ <?php echo e(number_format((float)$itemChange['total_price'], 2, ',', '.')); ?></span>
                                                                        </div>
                                                                    <?php endif; ?>
                                                                </div>
                                                                <?php if(isset($itemChange['sizes']) && is_array($itemChange['sizes'])): ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isset($itemChange['art_name'])): ?>
                                                                    <div class="mt-2 bg-purple-50 p-2 rounded text-xs">
                                                                        <span class="text-purple-700 font-medium">🎨 Arte: </span>
                                                                        <span class="text-purple-900"><?php echo e($itemChange['art_name']); ?></span>
                                                                    </div>
                                                                <?php endif; ?>
                                                                
                                                                <?php if(isset($itemChange['print_type']) && !in_array($itemChange['print_type'], ['', 'N/A', null])): ?>
                                                                    <div class="mt-3 border-t border-orange-200 pt-3">
                                                                        <div class="flex items-center space-x-2 mb-2">
                                                                            ...
                                                                            <span class="text-xs font-semibold text-indigo-900">
                                                                                🎨 Personalização: <?php echo e($itemChange['print_type']); ?>
                                                                ...
                                                                <?php if($hasSublimationDetails): ?>
                                                                        <div class="space-y-2">
                                                                            <?php $__currentLoopData = $itemChange['sublimations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subIndex => $sublimation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <?php if(is_array($sublimation)): ?>
                                                                                <div class="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-950/30 rounded-lg p-3 border border-indigo-200 dark:border-indigo-800">
                                                                                    <div class="flex items-center justify-between mb-2">
                                                                                        <span class="text-xs font-medium text-indigo-900 dark:text-indigo-300">Personalização <?php echo e($subIndex + 1); ?></span>
                                                                                        <?php if(isset($sublimation['final_price'])): ?>
                                                                                        <span class="text-xs font-bold text-indigo-700">R$ <?php echo e(number_format((float)$sublimation['final_price'], 2, ',', '.')); ?></span>
                                                                                        <?php endif; ?>
                                                                                    </div>
                                                                                    <div class="grid grid-cols-2 gap-2 text-xs">
                                                                                        <?php if(isset($sublimation['application_type'])): ?>
                                                                                            <div class="bg-white p-2 rounded">
                                                                                                <span class="text-gray-600 dark:text-slate-400">Tipo:</span>
                                                                                                <span class="font-medium text-indigo-900 ml-1"><?php echo e($sublimation['application_type']); ?></span>
                                                                                            </div>
                                                                                        <?php endif; ?>
                                                                                        <?php if(isset($sublimation['location_name'])): ?>
                                                                                            <div class="bg-white p-2 rounded">
                                                                                                <span class="text-gray-600 dark:text-slate-400">Localização:</span>
                                                                                                <span class="font-medium text-indigo-900 ml-1"><?php echo e($sublimation['location_name']); ?></span>
                                                                                            </div>
                                                                                        <?php endif; ?>
                                                                                        <?php if(isset($sublimation['size_name'])): ?>
                                                                                            <div class="bg-white p-2 rounded">
                                                                                                <span class="text-gray-600 dark:text-slate-400">Tamanho:</span>
                                                                                                <span class="font-medium text-indigo-900 ml-1"><?php echo e($sublimation['size_name']); ?></span>
                                                                                            </div>
                                                                                        <?php endif; ?>
                                                                                        <?php if(isset($sublimation['quantity'])): ?>
                                                                                            <div class="bg-white p-2 rounded">
                                                                                                <span class="text-gray-600 dark:text-slate-400">Quantidade:</span>
                                                                                                <span class="font-medium text-indigo-900 ml-1"><?php echo e($sublimation['quantity']); ?></span>
                                                                                            </div>
                                                                                        <?php endif; ?>
                                                                                        <?php if(isset($sublimation['color_count'])): ?>
                                                                                            <div class="bg-white p-2 rounded">
                                                                                                <span class="text-gray-600 dark:text-slate-400">Cores:</span>
                                                                                                <span class="font-medium text-indigo-900 ml-1"><?php echo e($sublimation['color_count']); ?></span>
                                                                                            </div>
                                                                                        <?php endif; ?>
                                                                                        <?php if(isset($sublimation['unit_price'])): ?>
                                                                                            <div class="bg-white p-2 rounded">
                                                                                                <span class="text-gray-600 dark:text-slate-400">Preço Unit.:</span>
                                                                                                <span class="font-medium text-indigo-900 ml-1">R$ <?php echo e(number_format((float)$sublimation['unit_price'], 2, ',', '.')); ?></span>
                                                                                            </div>
                                                                                        <?php endif; ?>
                                                                                    </div>
                                                                                    <?php if(isset($sublimation['files']) && is_array($sublimation['files']) && !empty($sublimation['files'])): ?>
                                                                                        <div class="mt-2 bg-white p-2 rounded">
                                                                                            <span class="text-xs text-gray-600">📎 Arquivos: </span>
                                                                                            <span class="text-xs text-gray-900 font-medium"><?php echo e(count($sublimation['files'])); ?> arquivo(s)</span>
                                                                                        </div>
                                                                                    <?php endif; ?>
                                                                                </div>
                                                                                <?php endif; ?>
                                                        ...
                                                        <?php else: ?>
                                                            <div class="bg-white dark:bg-slate-800 rounded-md p-2 text-xs text-gray-600">
                                                                <span class="font-medium">Item #<?php echo e($itemId); ?>:</span>
                                                                <span class="ml-2"><?php echo e($itemChange); ?></span>
                                                </div>
                                            <?php endif; ?>
                                                    <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if(isset($changes['payments']) && !empty($changes['payments'])): ?>
                                        <div class="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/50 dark:to-emerald-950/50 rounded-lg p-4 border border-green-200 dark:border-green-800">
                                            ...
                                            <div class="space-y-2">
                                                <?php $__currentLoopData = $changes['payments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paymentIndex => $paymentChanges): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(is_array($paymentChanges)): ?>
                                                        <?php $__currentLoopData = $paymentChanges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $change): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if(is_array($change) && isset($change['old']) && isset($change['new'])): ?>
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <div class="bg-white dark:bg-slate-800 rounded-md p-2 text-xs text-gray-600">
                                                            <?php echo e(is_array($paymentChanges) ? json_encode($paymentChanges) : $paymentChanges); ?>
...
<?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/components/edit-history.blade.php ENDPATH**/ ?>