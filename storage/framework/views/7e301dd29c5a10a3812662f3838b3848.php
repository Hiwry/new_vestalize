...
<head>
    ...
    <title>Meu Pedido #<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?></title>
...
<body class="client-order bg-gray-50 dark:bg-slate-950 min-h-screen transition-colors duration-200">
    ...
    <div class="bg-gray-800 dark:bg-gradient-to-r dark:from-indigo-700 dark:via-indigo-800 dark:to-purple-700 text-white py-6 px-4 mobile-padding shadow-sm dark:shadow-lg dark:shadow-indigo-900/30">
        <div class="max-w-md mx-auto">
            ...
            <p class="text-center text-gray-300 dark:text-indigo-200 mobile-text-sm">#<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?></p>
        </div>
    </div>
    ...
    <div class="max-w-md mx-auto mobile-padding">
        ...
        <div class="bg-white dark:bg-slate-900 rounded border border-gray-200 dark:border-slate-800 dark:shadow-2xl dark:shadow-black/20 p-4 mb-4">
            <div class="flex items-center justify-between mb-3">
                ...
                <span class="px-3 py-1 text-xs font-medium rounded-full text-white" 
                      style="background-color: <?php echo e($order->status->color); ?>">
            ...
            <div class="bg-gray-50 dark:bg-green-900/20 border border-gray-200 dark:border-green-800 rounded p-3 mb-3">
                ...
                <p class="text-gray-500 dark:text-green-400 mobile-text-xs mt-1">
                    Confirmado em <?php echo e($order->client_confirmed_at->format('d/m/Y H:i')); ?>
            ...
            <div class="grid grid-cols-2 gap-4 mobile-text-sm">
                <div>
                    ...
                    <p class="font-semibold text-gray-900 dark:text-white"><?php echo e($order->created_at->format('d/m/Y')); ?></p>
                </div>
                <?php if($order->delivery_date): ?>
                <div>
                    <p class="text-gray-500 dark:text-slate-400 mobile-text-xs">Previsão de Entrega</p>
                    <p class="font-semibold text-gray-900 dark:text-white"><?php echo e(\Carbon\Carbon::parse($order->delivery_date)->format('d/m/Y')); ?></p>
                </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded border border-gray-200 dark:border-slate-800 dark:shadow-2xl dark:shadow-black/20 p-4 mb-4">
            ...
            <div class="space-y-2 mobile-text-sm">
                <div>
                    ...
                    <p class="font-semibold text-gray-900 dark:text-white"><?php echo e($order->client->name); ?></p>
                </div>
                <div>
                    <p class="text-gray-500 dark:text-slate-400 mobile-text-xs">Telefone</p>
                    <p class="font-semibold text-gray-900 dark:text-white"><?php echo e($order->client->phone_primary); ?></p>
                </div>
                <?php if($order->client->email): ?>
                <div>
                    <p class="text-gray-500 dark:text-slate-400 mobile-text-xs">Email</p>
                    <p class="font-semibold text-gray-900 dark:text-white"><?php echo e($order->client->email); ?></p>
                </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded border border-gray-200 dark:border-slate-800 dark:shadow-2xl dark:shadow-black/20 p-4 mb-4">
            ...
            <div class="space-y-2 mobile-text-sm">
                <div>
                    ...
                    <p class="font-semibold text-gray-900 dark:text-white"><?php echo e($order->user->name); ?></p>
                </div>
                <?php if($order->user->store): ?>
                <div>
                    <p class="text-gray-500 dark:text-slate-400 mobile-text-xs">Loja</p>
                    <p class="font-semibold text-gray-900 dark:text-white"><?php echo e($order->user->store); ?></p>
                </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded border border-gray-200 dark:border-slate-800 dark:shadow-2xl dark:shadow-black/20 p-4 mb-4">
            <h2 class="text-base font-semibold text-gray-900 dark:text-white mb-3">Item <?php echo e($loop->iteration); ?> - <?php echo e($item->print_type); ?></h2>
            
            <?php if($item->art_name): ?>
            <div class="mb-3">
                <p class="text-gray-500 dark:text-slate-400 mobile-text-xs">Nome da Arte</p>
                <p class="font-medium mobile-text-sm"><?php echo e($item->art_name); ?></p>
            </div>
            <?php endif; ?>
            ...
            <div class="mb-3">
                ...
                <div class="text-center">
                    ...
                    <div class="text-gray-500 dark:text-slate-400 text-sm py-4 <?php echo e($imageUrl ? 'hidden' : ''); ?>">
                        ...
                        <p class="text-xs text-gray-400 dark:text-slate-500 mt-1"><?php echo e(basename($item->cover_image)); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="grid grid-cols-2 gap-2 mobile-text-sm">
                    <div>
                        ...
                        <span class="font-semibold text-gray-900 dark:text-white"><?php echo e($item->fabric); ?></span>
                    </div>
                    <div>
                        <span class="text-gray-500 dark:text-slate-400">Cor:</span>
                        <span class="font-semibold text-gray-900 dark:text-white"><?php echo e($item->color); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="bg-gray-50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700 p-3 rounded mb-2 mobile-text-sm">
                    ...
                    <div class="text-gray-600 mobile-text-xs">
                        ...
                        Qtd: <?php echo e($sub->quantity); ?>

                        <?php if($sub->color_count > 0): ?> | <?php echo e($sub->color_count); ?> cores <?php endif; ?>
                        <?php if($sub->has_neon): ?> | Neon <?php endif; ?>
                    </div>
                    
                    <!-- Imagem da Aplicação -->
                    <?php if($sub->application_image): ?>
                    <div class="mt-2">
                        <?php
                        ...
                        <?php if($appImageUrl): ?>
                            <p class="text-gray-600 dark:text-slate-400 mobile-text-xs mb-1">Imagem da Aplicação <?php echo e($index + 1); ?></p>
                            <div class="text-center">
                                <img src="<?php echo e($appImageUrl); ?>" 
                                 alt="Imagem da Aplicação <?php echo e($index + 1); ?>" 
                                     ...
                                     onclick="openImageModal('<?php echo e($appImageUrl); ?>')"
                                ...
                                <div class="hidden text-center text-gray-500 dark:text-slate-400 text-xs mt-1">
                                    ...
                                    <p class="text-xs mt-1"><?php echo e(basename($sub->application_image)); ?></p>
                                    <p class="text-xs mt-1 opacity-75">URL tentada: <?php echo e($appImageUrl); ?></p>
                                </div>
                            </div>
                        <?php else: ?>
                            <div class="text-center text-gray-500 dark:text-slate-400 text-xs mt-1">
                                ...
                                <?php if($sub->application_image): ?>
                                <p class="text-xs mt-1">Arquivo: <?php echo e(basename($sub->application_image)); ?></p>
                                <p class="text-xs mt-1 opacity-75">Caminho no BD: <?php echo e($sub->application_image); ?></p>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    </div>
            ...
            <div class="mb-3">
                ...
                <div class="grid grid-cols-5 gap-1 mobile-text-xs">
                    <?php $__currentLoopData = ['PP', 'P', 'M', 'G', 'GG']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="text-center p-1.5 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded text-sm text-gray-900 dark:text-white">
                        <div class="font-medium"><?php echo e($size); ?></div>
                        <div><?php echo e($itemSizes[$size] ?? 0); ?></div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <?php if(isset($itemSizes['EXG']) || isset($itemSizes['G1']) || isset($itemSizes['G2']) || isset($itemSizes['G3']) || isset($itemSizes['ESPECIAL'])): ?>
                <div class="grid grid-cols-5 gap-1 mobile-text-xs mt-1">
                    <?php $__currentLoopData = ['EXG', 'G1', 'G2', 'G3', 'ESPECIAL']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(isset($itemSizes[$size]) && $itemSizes[$size] > 0): ?>
                    <div class="text-center p-1.5 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded text-sm text-gray-900 dark:text-white">
                        <div class="font-medium"><?php echo e($size); ?></div>
                        <div><?php echo e($itemSizes[$size]); ?></div>
                    </div>
                    <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded border border-gray-200 dark:border-slate-800 dark:shadow-2xl dark:shadow-black/20 p-4 mb-4">
            ...
            <div class="space-y-2 mobile-text-sm">
                <div class="flex justify-between">
                    ...
                    <span class="font-semibold text-base text-gray-900 dark:text-white">R$ <?php echo e(number_format($order->total, 2, ',', '.')); ?></span>
                </div>
                <?php if($payment): ?>
                <div class="flex justify-between">
                    <span class="text-gray-500 dark:text-slate-400">Total Pago:</span>
                    <span class="font-medium text-gray-900 dark:text-green-400">R$ <?php echo e(number_format($payment->entry_amount, 2, ',', '.')); ?></span>
                </div>
                <div class="flex justify-between border-t pt-2">
                    <span class="text-gray-500 dark:text-slate-400"><?php echo e($payment->remaining_amount < 0 ? 'Crédito do Cliente:' : 'Restante:'); ?></span>
                    <span class="font-medium <?php echo e($payment->remaining_amount > 0 ? 'text-gray-900 dark:text-orange-400' : 'text-gray-900 dark:text-green-400'); ?>">
                        R$ <?php echo e(number_format(abs($payment->remaining_amount), 2, ',', '.')); ?>
        ...
        <div class="bg-gray-50 dark:bg-yellow-900/20 border border-gray-200 dark:border-yellow-800 rounded p-4 mb-4">
            ...
            <form method="POST" action="<?php echo e(route('client.order.confirm', $order->client_token)); ?>" id="client-confirm-form">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="tel" 
                               name="client_phone" 
                               value="<?php echo e($order->client->phone_primary); ?>"
                               class="w-full px-3 py-2 border border-gray-300 dark:border-slate-700 rounded bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:outline-none focus:border-gray-400 dark:focus:border-indigo-400 mobile-text-sm"
                               required>
                    </div>
        ...
        <div class="bg-gray-50 dark:bg-green-900/20 border border-gray-200 dark:border-green-800 rounded p-4 mb-4">
            ...
            <?php if($order->client_confirmation_notes): ?>
            <div class="mt-3 p-3 bg-white rounded border">
                <p class="text-gray-500 dark:text-slate-400 mobile-text-xs">Suas observações:</p>
                <p class="mobile-text-sm"><?php echo e($order->client_confirmation_notes); ?></p>
            </div>
            <?php endif; ?>
        </div>
        <?php endif; ?>
        ...
        <div class="bg-white dark:bg-slate-900 rounded border border-gray-200 dark:border-slate-800 dark:shadow-2xl dark:shadow-black/20 p-4 mb-4">
            ...
            <p class="mobile-text-sm text-gray-700"><?php echo e($order->notes); ?></p>
        </div>
        <?php endif; ?>
    ...
    <script>
        ...
        function openTermsModal() {
            ...
            const orderId = <?php echo e($order->id ?? 'null'); ?>;
...
<?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/client/order-show.blade.php ENDPATH**/ ?>