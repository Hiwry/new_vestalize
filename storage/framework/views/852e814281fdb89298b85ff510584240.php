...
<head>
    ...
    <title>Checkout - <?php echo e($plan->name); ?> | <?php echo e(config('app.name')); ?></title>
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8">
                ...
                <div class="mb-8 pb-6 border-b border-gray-200">
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-700"><?php echo e($plan->name); ?></h3>
...
<?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/subscription/mercadopago-checkout.blade.php ENDPATH**/ ?>