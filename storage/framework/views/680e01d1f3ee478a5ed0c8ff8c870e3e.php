...
<?php $__env->startSection('content'); ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e($stats['total_orders']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e($stats['total_users']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e($stats['total_sizes']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e($stats['pending_delivery_requests']); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        ...
                        <a href="<?php echo e(route('admin.cancellations.index')); ?>" 
                           class="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                            <div class="relative mr-3">
                                <svg class="h-6 w-6 text-red-600 dark:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                </svg>
                                <?php if(isset($stats['pending_cancellations']) && $stats['pending_cancellations'] > 0): ?>
                                <span class="absolute -top-1 -right-1 bg-red-500 dark:bg-red-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
                                    <?php echo e($stats['pending_cancellations']); ?>
                        ...
                        <a href="<?php echo e(route('delivery-requests.index')); ?>" 
                           class="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                            <svg class="h-6 w-6 text-indigo-600 dark:text-indigo-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <?php if($stats['pending_delivery_requests'] > 0): ?>
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300">
                                        <?php echo e($stats['pending_delivery_requests']); ?> pendente(s)
                                    </span>
                                <?php endif; ?>
                            </div>
                        </a>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-8 mb-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <a href="<?php echo e(route('admin.product-options.index')); ?>" 
                           class="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <a href="<?php echo e(route('admin.quick-products.index')); ?>" 
                           class="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                            <svg class="h-6 w-6 text-indigo-600 dark:text-indigo-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('admin.catalog-items.index')); ?>" 
                           class="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                            <svg class="h-6 w-6 text-indigo-600 dark:text-indigo-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        ...
                        <a href="<?php echo e(route('admin.company.settings')); ?>" 
                           class="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                            <svg class="h-6 w-6 text-purple-600 dark:text-purple-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('admin.edit-requests.index')); ?>" 
                           class="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                            ...
                            <div>
                                ...
                                <?php if(isset($stats['pending_edit_requests']) && $stats['pending_edit_requests'] > 0): ?>
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
                                        <?php echo e($stats['pending_edit_requests']); ?> pendente(s)
                                    </span>
                                <?php endif; ?>
                            </div>
                        </a>
                ...
                <div class="p-6">
                    <div class="mb-4 grid grid-cols-2 gap-4">
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e($stats['total_stores']); ?></p>
                        </div>
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                            <p class="text-sm text-gray-500 dark:text-gray-400">Sub-lojas</p>
                            <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e($stats['total_sub_stores']); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="space-y-2 max-h-64 overflow-y-auto">
                            <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($store->isMain() || !$store->parent_id): ?>
                                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <?php if($store->subStores->isNotEmpty()): ?>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                                        <?php echo e($store->subStores->count()); ?> sub-lojas
                                                    </p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($store->active ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300'); ?>">
                                            <?php echo e($store->active ? 'Ativa' : 'Inativa'); ?>
                                    ...
                                    <div class="mt-2 pl-7 space-y-1">
                                        <?php $__currentLoopData = $store->subStores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subStore): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center justify-between text-xs">
                                            <a href="<?php echo e(route('admin.stores.show', $subStore->id)); ?>" 
                                               class="text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center">
                                                ...
                                                <?php echo e($subStore->name); ?>

                                            </a>
                                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($subStore->active ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300'); ?>">
                                                <?php echo e($subStore->active ? 'Ativa' : 'Inativa'); ?>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
                    ...
                    <div class="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-700 last:border-b-0">
                        <div>
                            <p class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                Pedido #<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?>

                            </p>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                <?php echo e($order->client?->name ?? 'Sem cliente cadastrado'); ?>

                            </p>
                        </div>
                        <div class="text-right">
                            <p class="text-sm text-gray-900 dark:text-gray-100">R$ <?php echo e(number_format($order->total, 2, ',', '.')); ?></p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-700 last:border-b-0">
                        <div>
                            <p class="text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($user->name); ?></p>
                            <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($user->email); ?></p>
                        </div>
                        <div class="text-right">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($user->role === 'admin' ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800'); ?>">
                                <?php echo e(ucfirst($user->role)); ?>

                            </span>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"><?php echo e($user->created_at->format('d/m/Y')); ?></p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>