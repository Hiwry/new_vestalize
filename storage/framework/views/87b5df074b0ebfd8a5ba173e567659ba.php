...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-6 mb-6">
    <form method="GET" action="<?php echo e(route('production.dashboard')); ?>" id="dashboard-filter-form" class="space-y-4">
        <div class="flex items-end gap-4">
            <div class="flex-1">
                ...
                <select name="period" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all text-sm">
                    <option value="week" <?php echo e($period == 'week' ? 'selected' : ''); ?>>Semana</option>
                    <option value="month" <?php echo e($period == 'month' ? 'selected' : ''); ?>>Mês</option>
                    <option value="quarter" <?php echo e($period == 'quarter' ? 'selected' : ''); ?>>Trimestre</option>
                    <option value="year" <?php echo e($period == 'year' ? 'selected' : ''); ?>>Ano</option>
            ...
            <div>
                ...
                <input type="date" name="start_date" value="<?php echo e($startDate); ?>" class="px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all text-sm">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Data Final</label>
                <input type="date" name="end_date" value="<?php echo e($endDate); ?>" class="px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all text-sm">
            </div>
            <?php endif; ?>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
                ...
                <label class="flex items-center space-x-2 cursor-pointer p-2 rounded hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                    <input type="checkbox" 
                           ...
                           <?php echo e(in_array($status->id, $selectedColumns) ? 'checked' : ''); ?>

                           class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 column-checkbox">
                    <span class="text-sm text-gray-700 dark:text-gray-300"><?php echo e($status->name); ?></span>
                </label>
...
<div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-4">
        ...
        <div class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo e($totalOrders); ?></div>
    </div>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-4">
        <div class="text-sm text-gray-600 dark:text-gray-400">Em Produção</div>
        <div class="text-2xl font-bold text-blue-600 dark:text-blue-400"><?php echo e($ordersInProduction); ?></div>
    </div>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-4">
        <div class="text-sm text-gray-600 dark:text-gray-400">Tempo Médio Total</div>
        <div class="text-2xl font-bold text-gray-900 dark:text-gray-100">
            <?php if($avgProductionTime): ?>
                <?php
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-4">
        ...
        <div class="text-lg font-bold text-red-600 dark:text-red-400">
            <?php echo e($slowestStatus['status_name'] ?? 'N/A'); ?>

        </div>
        <?php if($slowestStatus): ?>
        <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">
            <?php echo e($slowestStatus['avg_formatted'] ?? 'N/A'); ?>
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex gap-2">
            <button onclick="changeDeliveryFilter('today')" 
                    class="px-4 py-2 rounded-md text-sm font-medium transition <?php echo e($deliveryFilter == 'today' ? 'bg-indigo-600 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600'); ?>">
                Hoje
            </button>
            <button onclick="changeDeliveryFilter('week')" 
                    class="px-4 py-2 rounded-md text-sm font-medium transition <?php echo e($deliveryFilter == 'week' ? 'bg-indigo-600 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600'); ?>">
                Esta Semana
            </button>
            <button onclick="changeDeliveryFilter('month')" 
                    class="px-4 py-2 rounded-md text-sm font-medium transition <?php echo e($deliveryFilter == 'month' ? 'bg-indigo-600 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600'); ?>">
                Este Mês
            </button>
        </div>
    </div>
    
    <?php if(isset($deliveryOrders) && $deliveryOrders && $deliveryOrders->count() > 0): ?>
    <div class="relative">
        <!-- Carrossel Container -->
        <div id="delivery-carousel" class="overflow-hidden">
            <div class="flex gap-4 overflow-x-auto pb-4" id="carousel-track">
                <?php $__currentLoopData = $deliveryOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="carousel-slide flex-shrink-0" style="min-width: 320px; max-width: 320px;">
                    <div class="kanban-card bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 shadow dark:shadow-gray-900/25 rounded-lg overflow-hidden cursor-pointer hover:shadow-xl dark:hover:shadow-gray-900/50 transition-all duration-200 border"
                         onclick="window.location.href='<?php echo e(route('orders.show', $order->id)); ?>'">
                        ...
                        <div class="p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <h3 class="font-semibold text-gray-900 dark:text-gray-100 text-sm truncate mb-1" title="<?php echo e($displayName); ?>">
                            ...
                            <div class="mb-3 pb-3 border-b border-gray-200 dark:border-gray-700">
                                ...
                                ?>
                                <div class="mt-1 text-xs font-medium <?php echo e($daysUntilDelivery < 0 ? 'text-red-600 dark:text-red-400' : ($daysUntilDelivery == 0 ? 'text-orange-600 dark:text-orange-400' : 'text-green-600 dark:text-green-400')); ?>">
                                    <?php if($daysUntilDelivery < 0): ?>
                                        Atrasado <?php echo e(abs($daysUntilDelivery)); ?> dia(s)
                                    <?php elseif($daysUntilDelivery == 0): ?>
                                        Entrega hoje!
                                    <?php else: ?>
                                        Em <?php echo e($daysUntilDelivery); ?> dia(s)
                                    <?php endif; ?>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center justify-between text-xs">
                                    ...
                                    <span class="font-medium text-gray-900 dark:text-gray-100"><?php echo e($order->items->sum('quantity')); ?> pçs</span>
                                </div>
                                
                                <div class="flex items-center justify-between text-xs">
                                    <span class="text-gray-500 dark:text-gray-400">Total:</span>
                                    <span class="font-bold text-indigo-600 dark:text-indigo-400">R$ <?php echo e(number_format($order->total, 2, ',', '.')); ?></span>
                                </div>
                                
                                <div class="flex items-center justify-between text-xs">
                                    <span class="text-gray-500 dark:text-gray-400">Status:</span>
                                    <span class="px-2 py-1 rounded-full text-xs font-medium" style="background: <?php echo e($order->status->color ?? '#6B7280'); ?>20; color: <?php echo e($order->status->color ?? '#6B7280'); ?>">
                                        <?php echo e($order->status->name ?? 'Sem status'); ?>
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="px-4 py-4 whitespace-nowrap">
                        <div class="text-sm font-semibold text-gray-900 dark:text-gray-100">
                            <?php echo e($stat['avg_formatted'] ?? 'N/A'); ?>

                        </div>
                    </td>
                    <td class="px-4 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900 dark:text-gray-100">
                            <?php echo e($stat['min_formatted'] ?? 'N/A'); ?>

                        </div>
                    </td>
                    <td class="px-4 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900 dark:text-gray-100">
                            <?php echo e($stat['max_formatted'] ?? 'N/A'); ?>

                        </div>
                    </td>
                    <td class="px-4 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900 dark:text-gray-100">
                            <?php echo e($ordersByStatus[$status->id] ?? 0); ?>
...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 p-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
            <div class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($status->name); ?></div>
            <div class="text-2xl font-bold text-gray-900 dark:text-gray-100">
                <?php echo e($ordersByStatus[$status->id] ?? 0); ?>
...
let currentIndex = 0;
let totalSlides = <?php echo e(isset($deliveryOrders) ? $deliveryOrders->count() : 0); ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/production/dashboard.blade.php ENDPATH**/ ?>