...
<div class="max-w-7xl mx-auto">
    ...
    ?>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl shadow-xl dark:shadow-2xl dark:shadow-black/20 border border-gray-200 dark:border-slate-800">
            ...
            <form id="orderArtForm" action="<?php echo e($customizationAction); ?>" method="POST" enctype="multipart/form-data" class="px-6 pt-6 pb-4">
                <?php echo csrf_field(); ?>
                ...
                <div class="bg-gradient-to-r from-slate-50 to-gray-50 dark:from-slate-800/40 dark:to-slate-800/20 rounded-xl border border-gray-200/80 dark:border-slate-700/50 p-5">
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                        ...
                        <div class="lg:col-span-4">
                            ...
                            <input id="order_art_name" type="text" name="order_art_name" value="<?php echo e($order->items->first()?->art_name); ?>" 
                        ...
                        <div class="lg:col-span-3">
                            ...
                            <select id="order_art_item" name="item_id" 
                                ...
                                <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>" <?php echo e($loop->first ? 'selected' : ''); ?>>
                                        Item <?php echo e($item->item_number); ?> • <?php echo e($item->quantity); ?> peças • <?php echo e($item->fabric); ?>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-800/10 rounded-xl p-4 border border-blue-100 dark:border-blue-800/50">
                            ...
                            <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($order->items->count()); ?></p>
                        </div>
                        <div class="bg-gradient-to-br from-violet-50 to-violet-100/50 dark:from-violet-900/20 dark:to-violet-800/10 rounded-xl p-4 border border-violet-100 dark:border-violet-800/50">
                            ...
                            <p class="text-2xl font-bold text-gray-900 dark:text-white" id="total-pecas" data-total-pecas="<?php echo e($order->items->sum('quantity')); ?>"><?php echo e($order->items->sum('quantity')); ?></p>
                        </div>
        <?php
            $totalApplications = 0;
        ...
        ?>
                        <div class="bg-gradient-to-br from-emerald-50 to-emerald-100/50 dark:from-emerald-900/20 dark:to-emerald-800/10 rounded-xl p-4 border border-emerald-100 dark:border-emerald-800/50">
                            ...
                            <p class="text-2xl font-bold text-emerald-600 dark:text-emerald-400">R$ <?php echo e(number_format($totalApplications, 2, ',', '.')); ?></p>
                            <p class="text-xs text-gray-500 dark:text-slate-400 mt-1"><?php echo e($totalApplicationsCount); ?> <?php echo e($totalApplicationsCount == 1 ? 'aplicação' : 'aplicações'); ?></p>
                        </div>
                        <div class="bg-gradient-to-br from-amber-50 to-amber-100/50 dark:from-amber-900/20 dark:to-amber-800/10 rounded-xl p-4 border border-amber-100 dark:border-amber-800/50">
                            ...
                            <p class="text-2xl font-bold text-amber-600 dark:text-amber-400">R$ <?php echo e(number_format($avgPerPiece, 2, ',', '.')); ?></p>
                ...
                <!-- Lista de Itens -->
                <div class="space-y-6">
                    <?php $__currentLoopData = $itemPersonalizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $item = $itemData['item'];
                        ...
                        <div class="border border-gray-200 dark:border-slate-700 rounded-xl overflow-hidden bg-white dark:bg-slate-800">
                            ...
                            <div class="bg-gray-50 dark:bg-slate-800/50 px-4 sm:px-5 py-4 border-b border-gray-200 dark:border-slate-700">
                                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-3">
                                    <div>
                                        <h3 class="font-semibold text-gray-900 dark:text-white">Item <?php echo e($item->item_number); ?></h3>
                                        <p class="text-sm text-gray-600 dark:text-slate-400 mt-0.5"><?php echo e($item->quantity); ?> peças • <?php echo e($item->fabric); ?> • <?php echo e($item->color); ?></p>
                                    </div>
                                    <span class="text-xs px-2.5 py-1 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 rounded-md font-medium">
                                        <?php echo e(count($persIds)); ?> <?php echo e(count($persIds) == 1 ? 'personalização' : 'personalizações'); ?>
                                ...
                                ?>
                                <?php if($itemApplicationsCount > 0): ?>
                                    <div class="grid grid-cols-3 gap-3 text-xs bg-white dark:bg-slate-800 rounded-lg p-2.5 border border-gray-200 dark:border-slate-700">
                                        <div>
                                            ...
                                            <span class="font-semibold text-gray-900 dark:text-white ml-1"><?php echo e($itemApplicationsCount); ?></span>
                                        </div>
                                        <div>
                                            <span class="text-gray-500 dark:text-slate-400">Total:</span>
                                            <span class="font-semibold text-indigo-600 dark:text-indigo-400 ml-1">R$ <?php echo e(number_format($itemTotalApplications, 2, ',', '.')); ?></span>
                                        </div>
                                        <div>
                                            <span class="text-gray-500 dark:text-slate-400">Por peça:</span>
                                            <span class="font-semibold text-indigo-600 dark:text-indigo-400 ml-1">R$ <?php echo e(number_format($itemAvgPerPiece, 2, ',', '.')); ?></span>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>

                            <?php if($item->art_name || ($item->files && $item->files->count())): ?>
                                <div class="mt-3 p-3 bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700">
                                    ...
                                    <?php endif; ?>
                                    <?php if($item->files && $item->files->count()): ?>
                                        <div>
                                            ...
                                            <div class="flex flex-wrap gap-2">
                                                <?php $__currentLoopData = $item->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <a href="<?php echo e(asset('storage/' . $file->file_path)); ?>" target="_blank" class="inline-flex items-center px-2.5 py-1 text-xs bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 rounded-md border border-indigo-100 dark:border-indigo-800 hover:bg-indigo-100 dark:hover:bg-indigo-800/70 transition">
                            ...
                            <div class="p-5 space-y-4">
                                ...
                                <?php $__currentLoopData = $persIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $persId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <div class="bg-gray-50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700 rounded-lg p-4">
                                        ...
                                        <div class="flex items-center justify-between mb-4">
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <h4 class="font-semibold text-gray-900 dark:text-white"><?php echo e($persName); ?></h4>
                                            </div>
                                            <button 
                                                type="button"
                                                onclick="openPersonalizationModal(<?php echo e($item->id); ?>, '<?php echo e($persName); ?>', <?php echo e($persId); ?>)"
                                        ...
                                        <div id="personalizations-list-<?php echo e($item->id); ?>-<?php echo e($persId); ?>" class="space-y-2">
                                            <?php if($existingPersonalizations->count() > 0): ?>
                                                <?php $__currentLoopData = $existingPersonalizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="p-3 bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700">
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex-1">
                                                                <div class="flex items-center space-x-4 text-sm">
                                                                    <?php if($pers->location_name): ?>
                                                                        <span class="text-gray-700 dark:text-slate-300"><strong class="dark:text-white">Local:</strong> <?php echo e($pers->location_name); ?></span>
                                                                    <?php endif; ?>
                                                                    <?php if($pers->size_name): ?>
                                                                        <span class="text-gray-700 dark:text-slate-300"><strong class="dark:text-white">Tamanho:</strong> <?php echo e($pers->size_name); ?></span>
                                                                    <?php endif; ?>
                                                                    <span class="text-gray-700 dark:text-slate-300"><strong class="dark:text-white">Qtd:</strong> <?php echo e($pers->quantity); ?></span>
                                                                    <?php if($pers->color_count): ?>
                                                                        <span class="text-gray-700 dark:text-slate-300"><strong class="dark:text-white">Cores:</strong> <?php echo e($pers->color_count); ?></span>
                                                                    <?php endif; ?>
                                                                    <?php if($pers->final_price > 0): ?>
                                                                        <span class="text-indigo-600 dark:text-indigo-400 font-semibold">R$ <?php echo e(number_format($pers->final_price, 2, ',', '.')); ?></span>
                                                                    <?php else: ?>
                                                        ...
                                                        <div class="flex space-x-2 ml-4">
                                                            <button 
                                                                type="button"
                                                                onclick="editPersonalization(<?php echo e($pers->id); ?>)"
                                                            ...
                                                            <button 
                                                                type="button"
                                                                onclick="removePersonalization(<?php echo e($pers->id); ?>)"
                                                        ...
                                                        <?php if($pers->files && $pers->files->count() > 0): ?>
                                                            <div class="mt-2 pt-2 border-t border-gray-200 dark:border-slate-700">
                                                                ...
                                                                <div class="flex flex-wrap gap-2">
                                                                    <?php $__currentLoopData = $pers->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <a href="<?php echo e(asset('storage/' . $file->file_path)); ?>" 
                                                                           download="<?php echo e($file->file_name); ?>"
                                                                           ...
                                                                           title="<?php echo e($file->file_name); ?> (<?php echo e($file->formatted_size); ?>)">
                                                                            <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10"></path>
                                                                            </svg>
                                                                            <span class="truncate max-w-xs"><?php echo e($file->file_name); ?></span>
                                                                        </a>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </div>
                                                            </div>
                ...
                <div class="mt-8 flex items-center justify-between pt-6 border-t border-gray-200 dark:border-slate-700">
                    <a href="<?php echo e(request()->routeIs('orders.edit.*') ? route('orders.edit.sewing') : route('orders.wizard.sewing')); ?>" 
    ...
    <div id="personalizationModal" class="hidden fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4 backdrop-blur-md">
        <div class="bg-slate-900 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-slate-700/50 animate-slideUp">
            ...
            <!-- Modal Body -->
            <form id="personalizationForm" action="<?php echo e($customizationAction); ?>" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="<?php if($order->is_draft): ?> hidden <?php endif; ?>">
                ...
                <div id="colorDetailsField" class="<?php if($order->is_draft): ?> hidden <?php endif; ?>">
...
<script>
        ...
        const personalizationSizes = <?php echo json_encode($personalizationData, 15, 512) ?>;
        const normalizeTypeKey = (type) => (type || '').toString().trim().toUpperCase();
        const orderArtData = <?php echo json_encode($orderArtData, 15, 512) ?>;
        
        // Configurações de personalização (charge_by_color, etc.)
        const personalizationSettings = <?php echo json_encode($personalizationSettings ?? [], 15, 512) ?>;
        ...
        function handleFormSubmit(event) {
            ...
            if (normalizedType === 'SUB. TOTAL') {
                ...
                const isDraft = <?php echo e($order->is_draft ? 'true' : 'false'); ?>;
                ...
                if (isValid) {
                    ...
                    const isEditing = <?php echo e(request()->routeIs('orders.edit.*') ? 'true' : 'false'); ?>;
                    
                    if (isEditing) {
                        form.action = '<?php echo e(route("orders.edit.customization")); ?>';
                    } else {
                        form.action = '<?php echo e(route("orders.wizard.customization")); ?>';
                    }
                    
                    form.removeEventListener('submit', handleFormSubmit);
                    
                    const formData = new FormData(form);
                    const targetUrl = isEditing ? '<?php echo e(route("orders.edit.customization")); ?>' : '<?php echo e(route("orders.wizard.customization")); ?>';
        ...
        ?>
        const availableAddons = <?php echo json_encode($addonsData, 15, 512) ?>;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('personalizationForm').addEventListener('submit', async function(e) {
                ...
                try {
                    const response = await fetch('<?php echo e(route("orders.wizard.customization")); ?>', {
                        method: 'POST',
                        headers: {
        ...
        async function updatePersonalizationsList() {
            try {
                ...
                const refreshUrl = isEditing 
                    ? '<?php echo e(route("orders.edit.customization")); ?>' 
                    : '<?php echo e(route("orders.wizard.customization.refresh")); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/orders/wizard/customization-multiple.blade.php ENDPATH**/ ?>