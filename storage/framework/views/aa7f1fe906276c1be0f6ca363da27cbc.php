...
<div class="max-w-6xl mx-auto">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 dark:text-gray-400"><?php echo e($types[$type]); ?></span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/25 border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <form method="POST" action="<?php echo e(route('admin.personalization-prices.update', $type)); ?>" id="prices-form">
            <?php echo csrf_field(); ?>
...
<script>
    ...
    function loadExistingData() {
        ...
        console.log('Prices count:', <?php echo e($prices->count()); ?>);
        
        <?php if($prices->count() > 0): ?>
            console.log('Dados encontrados, processando...');
            
            const pricesData = <?php echo json_encode($prices, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\vestalize.10 (1)\vestalize.10\resources\views/admin/personalization-prices/edit.blade.php ENDPATH**/ ?>